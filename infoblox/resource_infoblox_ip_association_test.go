...
func TestAcc_resourceipAssociation(t *testing.T) {
	...
	expName3 := "infoblox_ip_association.foo"
	expContent3 := ibclient.NewHostRecord(
		"default",
		"testhostname.test.com",
		"", "",
		[]ibclient.HostRecordIpv4Addr{
	...
	expName4 := "infoblox_ip_association.foo"
	expContent4 := ibclient.NewHostRecord(
		"default",
		"testhostname.test.com",
		"", "",
		[]ibclient.HostRecordIpv4Addr{
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: fmt.Sprintf(config3),
				Check:  validateIPAssociation(expName3, expContent3),
			},
			{
				Config: fmt.Sprintf(config4),
				Check:  validateIPAssociation(expName4, expContent4),
			},
		},
	})
}
