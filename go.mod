...
require (
	...
	github.com/infobloxopen/infoblox-nios-go-client v0.1.2-0.20260817063941-577ef39fbd51
	github.com/infobloxopen/universal-ddi-go-client v0.4.1-0.20260807145052-09f312f4c5d6
