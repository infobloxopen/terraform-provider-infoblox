...
// RecordCaaNIOSFieldMap maps infoblox model fields to NIOS struct fields
var RecordCaaNIOSFieldMap = map[string]string{
	"Id":                     "Ref",
	"NIOS.CaFlag":            "CaFlag",
	"NIOS.CaTag":             "CaTag",
	"NIOS.CaValue":           "CaValue",
...
// RecordCaaUDDIFieldMap maps infoblox model fields to UDDI struct fields
var RecordCaaUDDIFieldMap = map[string]string{
...
// RecordCaaFilterFieldMap maps infoblox filter keys to backend-specific API filter field names
var RecordCaaFilterFieldMap = map[core.BackendType]map[string]string{
	core.BackendNIOS: {
		"id":                      "_ref",
		"nios.ca_flag":            "ca_flag",
		"nios.ca_tag":             "ca_tag",
		"nios.ca_value":           "ca_value",
		"nios.comment":            "comment",
		"nios.creator":            "creator",
