...
// RecordSvcbUDDIFieldMap maps infoblox model fields to UDDI struct fields
var RecordSvcbUDDIFieldMap = map[string]string{
...
// RecordSvcbFilterFieldMap maps infoblox filter keys to backend-specific API filter field names
var RecordSvcbFilterFieldMap = map[core.BackendType]map[string]string{
	core.BackendUDDI: {
