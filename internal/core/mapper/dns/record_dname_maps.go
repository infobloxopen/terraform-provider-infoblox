...
// RecordDnameNIOSFieldMap maps infoblox model fields to NIOS struct fields
var RecordDnameNIOSFieldMap = map[string]string{
	"Id":                     "Ref",
...
// RecordDnameUDDIFieldMap maps infoblox model fields to UDDI struct fields
var RecordDnameUDDIFieldMap = map[string]string{
...
// RecordDnameFilterFieldMap maps infoblox filter keys to backend-specific API filter field names
var RecordDnameFilterFieldMap = map[core.BackendType]map[string]string{
	core.BackendNIOS: {
		"id":                      "_ref",
		"nios.comment":            "comment",
		"nios.creator":            "creator",
