...
// RecordTxtNIOSFieldMap maps infoblox model fields to NIOS struct fields
var RecordTxtNIOSFieldMap = map[string]string{
	"Id":                     "Ref",
...
// RecordTxtUDDIFieldMap maps infoblox model fields to UDDI struct fields
var RecordTxtUDDIFieldMap = map[string]string{
...
// RecordTxtFilterFieldMap maps infoblox filter keys to backend-specific API filter field names
var RecordTxtFilterFieldMap = map[core.BackendType]map[string]string{
	core.BackendNIOS: {
		"id":                      "_ref",
		"nios.comment":            "comment",
		"nios.creator":            "creator",
