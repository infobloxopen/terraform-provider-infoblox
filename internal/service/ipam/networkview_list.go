...
var (
	...
	_ list.ListResourceWithValidateConfig = &NetworkviewList{}
)
...
func (l *NetworkviewList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Networkview from both the NIOS and UDDI backends.",
...
func (l *NetworkviewList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
