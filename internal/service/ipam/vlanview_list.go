...
var (
	_ list.ListResource                   = &VlanviewList{}
	_ list.ListResourceWithConfigure      = &VlanviewList{}
	_ list.ListResourceWithValidateConfig = &VlanviewList{}
)
...
func (l *VlanviewList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewVlanviewService(l.backend, client.NIOS, client.UDDI)
}

func (l *VlanviewList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Vlanview from the NIOS backend.",
...
func (l *VlanviewList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *VlanviewList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	var records []*coremodel.Vlanview
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Vlanview, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Vlanview, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Vlanview records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
