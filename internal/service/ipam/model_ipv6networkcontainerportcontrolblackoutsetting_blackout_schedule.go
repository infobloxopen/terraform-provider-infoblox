...
// Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleModel is the Terraform model for Ipv6networkcontainerportcontrolblackoutsettingBlackoutSchedule
...
// Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleAttrTypes contains the attribute types for Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleModel
...
// Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleResourceSchemaAttributes contains the schema attributes for Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleModel
...
// ExpandIpv6networkcontainerportcontrolblackoutsettingBlackoutSchedule converts a Terraform Object to SDK type
func ExpandIpv6networkcontainerportcontrolblackoutsettingBlackoutSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.Ipv6networkcontainerportcontrolblackoutsettingBlackoutSchedule {
...
func (m *Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.Ipv6networkcontainerportcontrolblackoutsettingBlackoutSchedule {
	if m == nil {
		return nil
	}
	to := &niosipam.Ipv6networkcontainerportcontrolblackoutsettingBlackoutSchedule{
...
// FlattenIpv6networkcontainerportcontrolblackoutsettingBlackoutSchedule converts an SDK type to Terraform Object
func FlattenIpv6networkcontainerportcontrolblackoutsettingBlackoutSchedule(ctx context.Context, from *niosipam.Ipv6networkcontainerportcontrolblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Ipv6networkcontainerportcontrolblackoutsettingBlackoutScheduleModel) Flatten(ctx context.Context, from *niosipam.Ipv6networkcontainerportcontrolblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
