...
// NetworkdiscoveryblackoutsettingBlackoutScheduleModel is the Terraform model for NetworkdiscoveryblackoutsettingBlackoutSchedule
...
// NetworkdiscoveryblackoutsettingBlackoutScheduleAttrTypes contains the attribute types for NetworkdiscoveryblackoutsettingBlackoutScheduleModel
...
// NetworkdiscoveryblackoutsettingBlackoutScheduleResourceSchemaAttributes contains the schema attributes for NetworkdiscoveryblackoutsettingBlackoutScheduleModel
...
// ExpandNetworkdiscoveryblackoutsettingBlackoutSchedule converts a Terraform Object to SDK type
func ExpandNetworkdiscoveryblackoutsettingBlackoutSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.NetworkdiscoveryblackoutsettingBlackoutSchedule {
...
func (m *NetworkdiscoveryblackoutsettingBlackoutScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.NetworkdiscoveryblackoutsettingBlackoutSchedule {
	if m == nil {
		return nil
	}
	to := &niosipam.NetworkdiscoveryblackoutsettingBlackoutSchedule{
...
// FlattenNetworkdiscoveryblackoutsettingBlackoutSchedule converts an SDK type to Terraform Object
func FlattenNetworkdiscoveryblackoutsettingBlackoutSchedule(ctx context.Context, from *niosipam.NetworkdiscoveryblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NetworkdiscoveryblackoutsettingBlackoutScheduleModel) Flatten(ctx context.Context, from *niosipam.NetworkdiscoveryblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
