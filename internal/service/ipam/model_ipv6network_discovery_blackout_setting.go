...
// Ipv6networkDiscoveryBlackoutSettingModel is the Terraform model for Ipv6networkDiscoveryBlackoutSetting
...
// Ipv6networkDiscoveryBlackoutSettingAttrTypes contains the attribute types for Ipv6networkDiscoveryBlackoutSettingModel
...
// Ipv6networkDiscoveryBlackoutSettingResourceSchemaAttributes contains the schema attributes for Ipv6networkDiscoveryBlackoutSettingModel
...
// ExpandIpv6networkDiscoveryBlackoutSetting converts a Terraform Object to SDK type
func ExpandIpv6networkDiscoveryBlackoutSetting(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.Ipv6networkDiscoveryBlackoutSetting {
...
func (m *Ipv6networkDiscoveryBlackoutSettingModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.Ipv6networkDiscoveryBlackoutSetting {
	if m == nil {
		return nil
	}
	to := &niosipam.Ipv6networkDiscoveryBlackoutSetting{
...
// FlattenIpv6networkDiscoveryBlackoutSetting converts an SDK type to Terraform Object
func FlattenIpv6networkDiscoveryBlackoutSetting(ctx context.Context, from *niosipam.Ipv6networkDiscoveryBlackoutSetting, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Ipv6networkDiscoveryBlackoutSettingModel) Flatten(ctx context.Context, from *niosipam.Ipv6networkDiscoveryBlackoutSetting, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
