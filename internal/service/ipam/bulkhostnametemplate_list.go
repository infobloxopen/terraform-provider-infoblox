...
var (
	_ list.ListResource                   = &BulkhostnametemplateList{}
	_ list.ListResourceWithConfigure      = &BulkhostnametemplateList{}
	_ list.ListResourceWithValidateConfig = &BulkhostnametemplateList{}
)
...
func (l *BulkhostnametemplateList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bulk_hostname_template"
}

func (l *BulkhostnametemplateList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewBulkhostnametemplateService(l.backend, client.NIOS, client.UDDI)
}

func (l *BulkhostnametemplateList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Bulkhostnametemplate from the NIOS backend.",
...
func (l *BulkhostnametemplateList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *BulkhostnametemplateList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_bulk_hostname_template list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Bulkhostnametemplate
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Bulkhostnametemplate, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Bulkhostnametemplate, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Bulkhostnametemplate records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
