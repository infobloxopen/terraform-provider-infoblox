...
// NetworkportcontrolblackoutsettingBlackoutScheduleResourceSchemaAttributes contains the schema attributes for NetworkportcontrolblackoutsettingBlackoutScheduleModel
...
// ExpandNetworkportcontrolblackoutsettingBlackoutSchedule converts a Terraform Object to SDK type
func ExpandNetworkportcontrolblackoutsettingBlackoutSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.NetworkportcontrolblackoutsettingBlackoutSchedule {
...
func (m *NetworkportcontrolblackoutsettingBlackoutScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.NetworkportcontrolblackoutsettingBlackoutSchedule {
	if m == nil {
		return nil
	}
	to := &niosipam.NetworkportcontrolblackoutsettingBlackoutSchedule{
...
// FlattenNetworkportcontrolblackoutsettingBlackoutSchedule converts an SDK type to Terraform Object
func FlattenNetworkportcontrolblackoutsettingBlackoutSchedule(ctx context.Context, from *niosipam.NetworkportcontrolblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NetworkportcontrolblackoutsettingBlackoutScheduleModel) Flatten(ctx context.Context, from *niosipam.NetworkportcontrolblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
