...
var (
	_ list.ListResource                   = &Ipv6networkList{}
	_ list.ListResourceWithConfigure      = &Ipv6networkList{}
	_ list.ListResourceWithValidateConfig = &Ipv6networkList{}
)
...
func (l *Ipv6networkList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6networkService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6networkList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6network from both the NIOS and UDDI backends.",
...
func (l *Ipv6networkList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *Ipv6networkList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	var records []*coremodel.Ipv6network
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6network, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6network, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6network records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
