...
// NetworkcontainerportcontrolblackoutsettingBlackoutScheduleModel is the Terraform model for NetworkcontainerportcontrolblackoutsettingBlackoutSchedule
...
// NetworkcontainerportcontrolblackoutsettingBlackoutScheduleAttrTypes contains the attribute types for NetworkcontainerportcontrolblackoutsettingBlackoutScheduleModel
...
// NetworkcontainerportcontrolblackoutsettingBlackoutScheduleResourceSchemaAttributes contains the schema attributes for NetworkcontainerportcontrolblackoutsettingBlackoutScheduleModel
...
// ExpandNetworkcontainerportcontrolblackoutsettingBlackoutSchedule converts a Terraform Object to SDK type
func ExpandNetworkcontainerportcontrolblackoutsettingBlackoutSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.NetworkcontainerportcontrolblackoutsettingBlackoutSchedule {
...
func (m *NetworkcontainerportcontrolblackoutsettingBlackoutScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.NetworkcontainerportcontrolblackoutsettingBlackoutSchedule {
	if m == nil {
		return nil
	}
	to := &niosipam.NetworkcontainerportcontrolblackoutsettingBlackoutSchedule{
...
// FlattenNetworkcontainerportcontrolblackoutsettingBlackoutSchedule converts an SDK type to Terraform Object
func FlattenNetworkcontainerportcontrolblackoutsettingBlackoutSchedule(ctx context.Context, from *niosipam.NetworkcontainerportcontrolblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NetworkcontainerportcontrolblackoutsettingBlackoutScheduleModel) Flatten(ctx context.Context, from *niosipam.NetworkcontainerportcontrolblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
