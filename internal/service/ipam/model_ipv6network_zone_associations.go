...
// Ipv6networkZoneAssociationsModel is the Terraform model for Ipv6networkZoneAssociations
...
// Ipv6networkZoneAssociationsAttrTypes contains the attribute types for Ipv6networkZoneAssociationsModel
...
// ExpandIpv6networkZoneAssociations converts a Terraform Object to SDK type
func ExpandIpv6networkZoneAssociations(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.Ipv6networkZoneAssociations {
...
func (m *Ipv6networkZoneAssociationsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.Ipv6networkZoneAssociations {
	if m == nil {
		return nil
	}
	to := &niosipam.Ipv6networkZoneAssociations{
...
// FlattenIpv6networkZoneAssociations converts an SDK type to Terraform Object
func FlattenIpv6networkZoneAssociations(ctx context.Context, from *niosipam.Ipv6networkZoneAssociations, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Ipv6networkZoneAssociationsModel) Flatten(ctx context.Context, from *niosipam.Ipv6networkZoneAssociations, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
