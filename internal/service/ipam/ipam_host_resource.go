...
var (
	_ resource.Resource                   = &IpamHostResource{}
	_ resource.ResourceWithValidateConfig = &IpamHostResource{}
	_ resource.ResourceWithConfigure      = &IpamHostResource{}
	_ resource.ResourceWithImportState    = &IpamHostResource{}
	_ resource.ResourceWithIdentity       = &IpamHostResource{}
)
...
func (r *IpamHostResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *IpamHostResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *IpamHostResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox IpamHost in the UDDI backend.",
		Attributes:          IpamHostResourceSchemaAttributes,
	}
}

func (r *IpamHostResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewIpamHostService(r.backend, client.NIOS, client.UDDI)
}

func (r *IpamHostResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.IpamHost](r.backend, op)
}

func (r *IpamHostResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data IpamHostModel
	...
	ValidateIpamHost(ctx, data, resp)
}
...
func (r *IpamHostResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create IpamHost: %s", err))
		return
	}
...
func (r *IpamHostResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read IpamHost: %s", err))
		return
	}
...
func (r *IpamHostResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update IpamHost: %s", err))
		return
	}
...
func (r *IpamHostResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete IpamHost: %s", err))
	}
}
