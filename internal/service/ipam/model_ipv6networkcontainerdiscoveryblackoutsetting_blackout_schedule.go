...
// Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleModel is the Terraform model for Ipv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule
...
// Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleAttrTypes contains the attribute types for Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleModel
...
// Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleResourceSchemaAttributes contains the schema attributes for Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleModel
...
// ExpandIpv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule converts a Terraform Object to SDK type
func ExpandIpv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosipam.Ipv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule {
...
func (m *Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosipam.Ipv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule {
	if m == nil {
		return nil
	}
	to := &niosipam.Ipv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule{
...
// FlattenIpv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule converts an SDK type to Terraform Object
func FlattenIpv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule(ctx context.Context, from *niosipam.Ipv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Ipv6networkcontainerdiscoveryblackoutsettingBlackoutScheduleModel) Flatten(ctx context.Context, from *niosipam.Ipv6networkcontainerdiscoveryblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
