...
var (
	_ list.ListResource                   = &InfraHostList{}
	_ list.ListResourceWithConfigure      = &InfraHostList{}
	_ list.ListResourceWithValidateConfig = &InfraHostList{}
)

func NewInfraHostList() list.ListResource {
	return &InfraHostList{}
}

type InfraHostList struct {
	backend core.BackendType
	service coresvc.InfraHostService
}

type InfraHostListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *InfraHostList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_infra_host"
}

func (l *InfraHostList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewInfraHostService(l.backend, client.NIOS, client.UDDI)
}

func (l *InfraHostList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox InfraHost from the UDDI backend.",
...
func (l *InfraHostList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data InfraHostListModel
...
func (l *InfraHostList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data InfraHostListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_infra_host list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.InfraHost
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.InfraHost, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.InfraHost, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list InfraHost records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
