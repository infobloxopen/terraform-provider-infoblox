...
var (
	_ resource.Resource                   = &NamedListResource{}
	_ resource.ResourceWithValidateConfig = &NamedListResource{}
	_ resource.ResourceWithConfigure      = &NamedListResource{}
	_ resource.ResourceWithImportState    = &NamedListResource{}
	_ resource.ResourceWithIdentity       = &NamedListResource{}
)
...
func (r *NamedListResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *NamedListResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Named List ( Custom List ) in the UDDI backend.",
		Attributes:          NamedListResourceSchemaAttributes,
	}
}

func (r *NamedListResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewNamedListService(r.backend, client.NIOS, client.UDDI)
}

func (r *NamedListResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.NamedList](r.backend, op)
}

func (r *NamedListResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data NamedListModel
	...
	ValidateNamedList(ctx, data, resp)
}
...
func (r *NamedListResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create NamedList: %s", err))
		return
	}
...
func (r *NamedListResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read NamedList: %s", err))
		return
	}
...
func (r *NamedListResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update NamedList: %s", err))
		return
	}
...
func (r *NamedListResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete NamedList: %s", err))
	}
}
