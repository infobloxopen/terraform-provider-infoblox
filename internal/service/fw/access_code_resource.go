...
var (
	_ resource.Resource                   = &AccessCodeResource{}
	_ resource.ResourceWithValidateConfig = &AccessCodeResource{}
	_ resource.ResourceWithConfigure      = &AccessCodeResource{}
	_ resource.ResourceWithImportState    = &AccessCodeResource{}
	_ resource.ResourceWithIdentity       = &AccessCodeResource{}
)
...
func (r *AccessCodeResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *AccessCodeResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *AccessCodeResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox AccessCode in the UDDI backend.",
		Attributes:          AccessCodeResourceSchemaAttributes,
	}
}

func (r *AccessCodeResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewAccessCodeService(r.backend, client.NIOS, client.UDDI)
}

func (r *AccessCodeResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.AccessCode](r.backend, op)
}

func (r *AccessCodeResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data AccessCodeModel
	...
	ValidateAccessCode(ctx, data, resp)
}
...
func (r *AccessCodeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create AccessCode: %s", err))
		return
	}
...
func (r *AccessCodeResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read AccessCode: %s", err))
		return
	}
...
func (r *AccessCodeResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update AccessCode: %s", err))
		return
	}
...
func (r *AccessCodeResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete AccessCode: %s", err))
	}
}
