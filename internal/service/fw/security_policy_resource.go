...
var (
	...
	_ resource.ResourceWithIdentity       = &SecurityPolicyResource{}
)
...
func (r *SecurityPolicyResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *SecurityPolicyResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox SecurityPolicy in the UDDI backend.",
		Attributes:          SecurityPolicyResourceSchemaAttributes,
	}
}
...
func (r *SecurityPolicyResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewSecurityPolicyService(r.backend, client.NIOS, client.UDDI)
}

func (r *SecurityPolicyResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.SecurityPolicy](r.backend, op)
}
...
func (r *SecurityPolicyResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateSecurityPolicy(ctx, data, resp)
}
...
func (r *SecurityPolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.SecurityPolicy
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create SecurityPolicy: %s", err))
		return
	}
...
func (r *SecurityPolicyResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read SecurityPolicy: %s", err))
		return
	}
...
func (r *SecurityPolicyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update SecurityPolicy: %s", err))
		return
	}
...
func (r *SecurityPolicyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete SecurityPolicy: %s", err))
	}
}
...
func (r *SecurityPolicyResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError(
			"Invalid Import ID",
			fmt.Sprintf("Expected a numeric SecurityPolicy ID, got %q: %s", req.ID, err),
		)
		return
	}
