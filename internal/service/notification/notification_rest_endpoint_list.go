...
var (
	_ list.ListResource                   = &NotificationRestEndpointList{}
	_ list.ListResourceWithConfigure      = &NotificationRestEndpointList{}
	_ list.ListResourceWithValidateConfig = &NotificationRestEndpointList{}
)

func NewNotificationRestEndpointList() list.ListResource {
	return &NotificationRestEndpointList{}
}

type NotificationRestEndpointList struct {
	backend core.BackendType
	service coresvc.NotificationRestEndpointService
}

type NotificationRestEndpointListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *NotificationRestEndpointList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_notification_rest_endpoint"
}

func (l *NotificationRestEndpointList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewNotificationRestEndpointService(l.backend, client.NIOS, client.UDDI)
}

func (l *NotificationRestEndpointList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox NotificationRestEndpoint from the NIOS backend.",
...
func (l *NotificationRestEndpointList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data NotificationRestEndpointListModel
...
func (l *NotificationRestEndpointList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data NotificationRestEndpointListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_notification_rest_endpoint list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.NotificationRestEndpoint
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.NotificationRestEndpoint, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.NotificationRestEndpoint, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list NotificationRestEndpoint records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
