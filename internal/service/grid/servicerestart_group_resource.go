...
var (
	_ resource.Resource                   = &ServicerestartGroupResource{}
	_ resource.ResourceWithValidateConfig = &ServicerestartGroupResource{}
	_ resource.ResourceWithConfigure      = &ServicerestartGroupResource{}
	_ resource.ResourceWithImportState    = &ServicerestartGroupResource{}
	_ resource.ResourceWithIdentity       = &ServicerestartGroupResource{}
)

func NewServicerestartGroupResource() resource.Resource {
	return &ServicerestartGroupResource{}
}

type ServicerestartGroupResource struct {
	backend core.BackendType
	service coresvc.ServicerestartGroupService
}

func (r *ServicerestartGroupResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_servicerestart_group"
	resp.ResourceBehavior = resource.ResourceBehavior{
		MutableIdentity: true,
	}
}

func (r *ServicerestartGroupResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *ServicerestartGroupResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox ServicerestartGroup in the NIOS backend.",
		Attributes:          ServicerestartGroupResourceSchemaAttributes,
	}
}

func (r *ServicerestartGroupResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewServicerestartGroupService(r.backend, client.NIOS, client.UDDI)
}

func (r *ServicerestartGroupResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.ServicerestartGroup](r.backend, op)
}

func (r *ServicerestartGroupResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data ServicerestartGroupModel
	...
	ValidateServicerestartGroup(ctx, data, resp)
}

func (r *ServicerestartGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ServicerestartGroupModel
	...
	if r.backend == core.BackendNIOS {
		nios := flex.ExpandNestedObject[NIOSServicerestartGroupModel](ctx, data.NIOS, &resp.Diagnostics)
		if nios == nil {
			nios = &NIOSServicerestartGroupModel{}
		}
		nios.ExtAttrs = flex.SetInternalID(ctx, nios.ExtAttrs, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
		data.NIOS = flex.FlattenNestedObject(ctx, nios, NIOSServicerestartGroupAttrTypes, &resp.Diagnostics)
	}
	...
	var (
		apiResp  *coremodel.ServicerestartGroup
	...
	err := retry.Do(ctx, r.retryPolicy(retry.OpCreate), func(ctx context.Context) (int, error) {
		...
		apiResp, httpResp, apiErr = r.service.Create(ctx, obj, &core.Options{
			ReturnFields: ServicerestartGroupReturnFields,
		})
		if httpResp != nil {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create ServicerestartGroup: %s", err))
		return
	}
...
func (r *ServicerestartGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data ServicerestartGroupModel
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read ServicerestartGroup: %s", err))
		return
	}
	...
	if r.backend == core.BackendNIOS && associateInternalId == nil && apiResp.NIOS != nil {
		...
		stateNIOS := flex.ExpandNestedObject[NIOSServicerestartGroupModel](ctx, data.NIOS, &resp.Diagnostics)
		if stateNIOS == nil || stateNIOS.ExtAttrsAll.IsNull() || stateNIOS.ExtAttrsAll.IsUnknown() {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read ServicerestartGroup because the internal ID (from ext_attrs_all) is missing or invalid.",
			)
			return
		}
...
func (r *ServicerestartGroupResource) ReadByExtAttrs(ctx context.Context, data *ServicerestartGroupModel, resp *resource.ReadResponse) bool {
	...
	var (
		records  []*coremodel.ServicerestartGroup
		httpResp *http.Response
	)
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to search ServicerestartGroup by extattrs: %s", err))
		return true
	}
...
func (r *ServicerestartGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data ServicerestartGroupModel
	...
	if r.backend == core.BackendNIOS {
		...
		planNIOS := flex.ExpandNestedObject[NIOSServicerestartGroupModel](ctx, data.NIOS, &resp.Diagnostics)
		stateNIOS := flex.ExpandNestedObject[NIOSServicerestartGroupModel](ctx, stateNIOSObj, &resp.Diagnostics)
		if planNIOS == nil {
			planNIOS = &NIOSServicerestartGroupModel{}
		}
		...
		data.NIOS = flex.FlattenNestedObject(ctx, planNIOS, NIOSServicerestartGroupAttrTypes, &resp.Diagnostics)
	}
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update ServicerestartGroup: %s", err))
		return
	}

	// Restore the plan ext_attrs (without inherited EAs) so Flatten preserves the user's input
	if r.backend == core.BackendNIOS {
		niosObj := flex.ExpandNestedObject[NIOSServicerestartGroupModel](ctx, data.NIOS, &resp.Diagnostics)
		if niosObj != nil {
			niosObj.ExtAttrs = planExtAttrs
			data.NIOS = flex.FlattenNestedObject(ctx, niosObj, NIOSServicerestartGroupAttrTypes, &resp.Diagnostics)
			if resp.Diagnostics.HasError() {
				return
			}
		}
...
func (r *ServicerestartGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data ServicerestartGroupModel
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete ServicerestartGroup: %s", err))
	}
}

func (r *ServicerestartGroupResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
