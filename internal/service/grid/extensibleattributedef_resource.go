...
var (
	_ resource.Resource                   = &ExtensibleattributedefResource{}
	_ resource.ResourceWithValidateConfig = &ExtensibleattributedefResource{}
	_ resource.ResourceWithConfigure      = &ExtensibleattributedefResource{}
	_ resource.ResourceWithImportState    = &ExtensibleattributedefResource{}
	_ resource.ResourceWithIdentity       = &ExtensibleattributedefResource{}
)
...
func (r *ExtensibleattributedefResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *ExtensibleattributedefResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Extensibleattributedef in the NIOS backend.",
		Attributes:          ExtensibleattributedefResourceSchemaAttributes,
	}
}

func (r *ExtensibleattributedefResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewExtensibleattributedefService(r.backend, client.NIOS, client.UDDI)
}

func (r *ExtensibleattributedefResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Extensibleattributedef](r.backend, op)
}
...
func (r *ExtensibleattributedefResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateExtensibleattributedef(ctx, data, resp)
}
...
func (r *ExtensibleattributedefResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.Extensibleattributedef
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Extensibleattributedef: %s", err))
		return
	}
...
func (r *ExtensibleattributedefResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Extensibleattributedef: %s", err))
		return
	}
...
func (r *ExtensibleattributedefResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Extensibleattributedef: %s", err))
		return
	}
...
func (r *ExtensibleattributedefResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Extensibleattributedef: %s", err))
	}
}
