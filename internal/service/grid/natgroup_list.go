...
var (
	_ list.ListResource                   = &NatgroupList{}
	_ list.ListResourceWithConfigure      = &NatgroupList{}
	_ list.ListResourceWithValidateConfig = &NatgroupList{}
)

func NewNatgroupList() list.ListResource {
	return &NatgroupList{}
}

type NatgroupList struct {
	backend core.BackendType
	service coresvc.NatgroupService
}

type NatgroupListModel struct {
...
func (l *NatgroupList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewNatgroupService(l.backend, client.NIOS, client.UDDI)
}

func (l *NatgroupList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Natgroup from the NIOS backend.",
...
func (l *NatgroupList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data NatgroupListModel
...
func (l *NatgroupList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data NatgroupListModel
	...
	var records []*coremodel.Natgroup
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Natgroup, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Natgroup, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Natgroup records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
