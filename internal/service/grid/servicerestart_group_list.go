...
var (
	_ list.ListResource                   = &ServicerestartGroupList{}
	_ list.ListResourceWithConfigure      = &ServicerestartGroupList{}
	_ list.ListResourceWithValidateConfig = &ServicerestartGroupList{}
)

func NewServicerestartGroupList() list.ListResource {
	return &ServicerestartGroupList{}
}

type ServicerestartGroupList struct {
	backend core.BackendType
	service coresvc.ServicerestartGroupService
}

type ServicerestartGroupListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *ServicerestartGroupList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_servicerestart_group"
}

func (l *ServicerestartGroupList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewServicerestartGroupService(l.backend, client.NIOS, client.UDDI)
}

func (l *ServicerestartGroupList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox ServicerestartGroup from the NIOS backend.",
...
func (l *ServicerestartGroupList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data ServicerestartGroupListModel
...
func (l *ServicerestartGroupList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data ServicerestartGroupListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_servicerestart_group list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.ServicerestartGroup
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.ServicerestartGroup, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.ServicerestartGroup, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list ServicerestartGroup records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
