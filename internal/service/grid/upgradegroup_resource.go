...
var (
	_ resource.Resource                   = &UpgradegroupResource{}
	_ resource.ResourceWithValidateConfig = &UpgradegroupResource{}
	_ resource.ResourceWithConfigure      = &UpgradegroupResource{}
	_ resource.ResourceWithImportState    = &UpgradegroupResource{}
	_ resource.ResourceWithIdentity       = &UpgradegroupResource{}
)
...
func (r *UpgradegroupResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *UpgradegroupResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Upgradegroup in the NIOS backend.",
		Attributes:          UpgradegroupResourceSchemaAttributes,
	}
}

func (r *UpgradegroupResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewUpgradegroupService(r.backend, client.NIOS, client.UDDI)
}

func (r *UpgradegroupResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Upgradegroup](r.backend, op)
}
...
func (r *UpgradegroupResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateUpgradegroup(ctx, data, resp)
}
...
func (r *UpgradegroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.Upgradegroup
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Upgradegroup: %s", err))
		return
	}
...
func (r *UpgradegroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Upgradegroup: %s", err))
		return
	}
...
func (r *UpgradegroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Upgradegroup: %s", err))
		return
	}
...
func (r *UpgradegroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Upgradegroup: %s", err))
	}
}
