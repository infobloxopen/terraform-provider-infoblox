...
var (
	_ list.ListResource                   = &DtcLbdnList{}
	_ list.ListResourceWithConfigure      = &DtcLbdnList{}
	_ list.ListResourceWithValidateConfig = &DtcLbdnList{}
)

func NewDtcLbdnList() list.ListResource {
	return &DtcLbdnList{}
}
...
type DtcLbdnListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
	TagFilters     types.Map `tfsdk:"tag_filters"`
}

func (l *DtcLbdnList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dtc_lbdn"
}

func (l *DtcLbdnList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewDtcLbdnService(l.backend, client.NIOS, client.UDDI)
}

func (l *DtcLbdnList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox DtcLbdn from both the NIOS and UDDI backends.",
...
func (l *DtcLbdnList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data DtcLbdnListModel
...
func (l *DtcLbdnList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data DtcLbdnListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_dtc_lbdn list: req.Limit=%d backend=%s includeResource=%t",
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.DtcLbdn, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.DtcLbdn, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list DtcLbdn records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
