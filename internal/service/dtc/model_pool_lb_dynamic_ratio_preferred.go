...
// PoolLbDynamicRatioPreferredModel is the Terraform model for PoolLbDynamicRatioPreferred
type PoolLbDynamicRatioPreferredModel struct {
...
// PoolLbDynamicRatioPreferredAttrTypes contains the attribute types for PoolLbDynamicRatioPreferredModel
var PoolLbDynamicRatioPreferredAttrTypes = map[string]attr.Type{
...
// ExpandPoolLbDynamicRatioPreferred converts a Terraform Object to SDK type
func ExpandPoolLbDynamicRatioPreferred(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdtc.DtcPoolLbDynamicRatioPreferred {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m PoolLbDynamicRatioPreferredModel
...
func (m *PoolLbDynamicRatioPreferredModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdtc.DtcPoolLbDynamicRatioPreferred {
	if m == nil {
		return nil
	}
...
// FlattenPoolLbDynamicRatioPreferred converts an SDK type to Terraform Object
func FlattenPoolLbDynamicRatioPreferred(ctx context.Context, from *niosdtc.DtcPoolLbDynamicRatioPreferred, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(PoolLbDynamicRatioPreferredAttrTypes)
	}
	m := &PoolLbDynamicRatioPreferredModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, PoolLbDynamicRatioPreferredAttrTypes, m)
	diags.Append(d...)
	return t
}

// Flatten populates the Terraform model from SDK type
func (m *PoolLbDynamicRatioPreferredModel) Flatten(ctx context.Context, from *niosdtc.DtcPoolLbDynamicRatioPreferred, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
