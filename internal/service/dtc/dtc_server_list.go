...
var (
	_ list.ListResource                   = &DtcServerList{}
	_ list.ListResourceWithConfigure      = &DtcServerList{}
	_ list.ListResourceWithValidateConfig = &DtcServerList{}
)

func NewDtcServerList() list.ListResource {
	return &DtcServerList{}
}
...
type DtcServerListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
	TagFilters     types.Map `tfsdk:"tag_filters"`
}

func (l *DtcServerList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dtc_server"
}

func (l *DtcServerList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewDtcServerService(l.backend, client.NIOS, client.UDDI)
}

func (l *DtcServerList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox DtcServer from both the NIOS and UDDI backends.",
...
func (l *DtcServerList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data DtcServerListModel
...
func (l *DtcServerList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data DtcServerListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_dtc_server list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.DtcServer
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.DtcServer, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.DtcServer, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list DtcServer records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
