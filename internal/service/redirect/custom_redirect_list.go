...
var (
	_ list.ListResource                   = &CustomRedirectList{}
	_ list.ListResourceWithConfigure      = &CustomRedirectList{}
	_ list.ListResourceWithValidateConfig = &CustomRedirectList{}
)

func NewCustomRedirectList() list.ListResource {
	return &CustomRedirectList{}
}

type CustomRedirectList struct {
	backend core.BackendType
	service coresvc.CustomRedirectService
}

type CustomRedirectListModel struct {
	Filters types.Map `tfsdk:"filters"`
}

func (l *CustomRedirectList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_custom_redirect"
}

func (l *CustomRedirectList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewCustomRedirectService(l.backend, client.NIOS, client.UDDI)
}

func (l *CustomRedirectList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox CustomRedirect from the UDDI backend.",
...
func (l *CustomRedirectList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data CustomRedirectListModel
...
func (l *CustomRedirectList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data CustomRedirectListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_custom_redirect list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.CustomRedirect
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.CustomRedirect, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.CustomRedirect, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list CustomRedirect records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
