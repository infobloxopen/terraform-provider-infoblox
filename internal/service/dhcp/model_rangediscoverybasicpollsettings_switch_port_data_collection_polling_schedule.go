...
// RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleModel is the Terraform model for RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
...
// RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleAttrTypes contains the attribute types for RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleModel
...
// RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleResourceSchemaAttributes contains the schema attributes for RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleModel
...
// ExpandRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule converts a Terraform Object to SDK type
func ExpandRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
...
func (m *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	if m == nil {
		return nil
	}
	to := &niosdhcp.RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{
...
// FlattenRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule converts an SDK type to Terraform Object
func FlattenRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(ctx context.Context, from *niosdhcp.RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleModel) Flatten(ctx context.Context, from *niosdhcp.RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
