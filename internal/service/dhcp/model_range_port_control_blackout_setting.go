...
// RangePortControlBlackoutSettingModel is the Terraform model for RangePortControlBlackoutSetting
...
// RangePortControlBlackoutSettingAttrTypes contains the attribute types for RangePortControlBlackoutSettingModel
...
// RangePortControlBlackoutSettingResourceSchemaAttributes contains the schema attributes for RangePortControlBlackoutSettingModel
...
// ExpandRangePortControlBlackoutSetting converts a Terraform Object to SDK type
func ExpandRangePortControlBlackoutSetting(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.RangePortControlBlackoutSetting {
...
func (m *RangePortControlBlackoutSettingModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.RangePortControlBlackoutSetting {
	if m == nil {
		return nil
	}
	to := &niosdhcp.RangePortControlBlackoutSetting{
...
// FlattenRangePortControlBlackoutSetting converts an SDK type to Terraform Object
func FlattenRangePortControlBlackoutSetting(ctx context.Context, from *niosdhcp.RangePortControlBlackoutSetting, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RangePortControlBlackoutSettingModel) Flatten(ctx context.Context, from *niosdhcp.RangePortControlBlackoutSetting, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
