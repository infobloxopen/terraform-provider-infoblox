...
func ExpandUtilizationThreshold(ctx context.Context, o types.Object, diags *diag.Diagnostics) *uddidhcp.UtilizationThreshold {
...
func (m *UtilizationThresholdModel) Expand(ctx context.Context, diags *diag.Diagnostics) *uddidhcp.UtilizationThreshold {
	if m == nil {
		return nil
	}
	to := &uddidhcp.UtilizationThreshold{
...
func FlattenUtilizationThreshold(ctx context.Context, from *uddidhcp.UtilizationThreshold, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *UtilizationThresholdModel) Flatten(ctx context.Context, from *uddidhcp.UtilizationThreshold, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
