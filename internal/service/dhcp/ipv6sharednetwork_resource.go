...
var (
	_ resource.Resource                   = &Ipv6sharednetworkResource{}
	_ resource.ResourceWithValidateConfig = &Ipv6sharednetworkResource{}
	_ resource.ResourceWithConfigure      = &Ipv6sharednetworkResource{}
	_ resource.ResourceWithImportState    = &Ipv6sharednetworkResource{}
	_ resource.ResourceWithIdentity       = &Ipv6sharednetworkResource{}
)
...
func (r *Ipv6sharednetworkResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *Ipv6sharednetworkResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *Ipv6sharednetworkResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Ipv6sharednetwork in the NIOS backend.",
		Attributes:          Ipv6sharednetworkResourceSchemaAttributes,
	}
}

func (r *Ipv6sharednetworkResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewIpv6sharednetworkService(r.backend, client.NIOS, client.UDDI)
}

func (r *Ipv6sharednetworkResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Ipv6sharednetwork](r.backend, op)
}
...
func (r *Ipv6sharednetworkResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateIpv6sharednetwork(ctx, data, resp)
}
...
func (r *Ipv6sharednetworkResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if r.backend == core.BackendNIOS {
		nios := flex.ExpandNestedObject[NIOSIpv6sharednetworkModel](ctx, data.NIOS, &resp.Diagnostics)
		if nios == nil {
			nios = &NIOSIpv6sharednetworkModel{}
		}
		nios.ExtAttrs = flex.SetInternalID(ctx, nios.ExtAttrs, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
		data.NIOS = flex.FlattenNestedObject(ctx, nios, NIOSIpv6sharednetworkAttrTypes, &resp.Diagnostics)
	}
	...
	if r.backend == core.BackendNIOS {
		ApplyIpv6sharednetworkNIOSUseFlags(ctx, req.Config, obj, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
	}
	...
	var (
		apiResp  *coremodel.Ipv6sharednetwork
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Ipv6sharednetwork: %s", err))
		return
	}
...
func (r *Ipv6sharednetworkResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Ipv6sharednetwork: %s", err))
		return
	}
	...
	if r.backend == core.BackendNIOS && associateInternalId == nil && apiResp.NIOS != nil {
		...
		stateNIOS := flex.ExpandNestedObject[NIOSIpv6sharednetworkModel](ctx, data.NIOS, &resp.Diagnostics)
		if stateNIOS == nil || stateNIOS.ExtAttrsAll.IsNull() || stateNIOS.ExtAttrsAll.IsUnknown() {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read Ipv6sharednetwork because the internal ID (from ext_attrs_all) is missing or invalid.",
			)
			return
		}
...
func (r *Ipv6sharednetworkResource) ReadByExtAttrs(ctx context.Context, data *Ipv6sharednetworkModel, resp *resource.ReadResponse) bool {
	...
	var (
		records  []*coremodel.Ipv6sharednetwork
		httpResp *http.Response
	)
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to search Ipv6sharednetwork by extattrs: %s", err))
		return true
	}
...
func (r *Ipv6sharednetworkResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if r.backend == core.BackendNIOS {
		...
		planNIOS := flex.ExpandNestedObject[NIOSIpv6sharednetworkModel](ctx, data.NIOS, &resp.Diagnostics)
		stateNIOS := flex.ExpandNestedObject[NIOSIpv6sharednetworkModel](ctx, stateNIOSObj, &resp.Diagnostics)
		if planNIOS == nil {
			planNIOS = &NIOSIpv6sharednetworkModel{}
		}
		...
		data.NIOS = flex.FlattenNestedObject(ctx, planNIOS, NIOSIpv6sharednetworkAttrTypes, &resp.Diagnostics)
	}
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Ipv6sharednetwork: %s", err))
		return
	}

	// Restore the plan ext_attrs (without inherited EAs) so Flatten preserves the user's input
	if r.backend == core.BackendNIOS {
		niosObj := flex.ExpandNestedObject[NIOSIpv6sharednetworkModel](ctx, data.NIOS, &resp.Diagnostics)
		if niosObj != nil {
			niosObj.ExtAttrs = planExtAttrs
			data.NIOS = flex.FlattenNestedObject(ctx, niosObj, NIOSIpv6sharednetworkAttrTypes, &resp.Diagnostics)
			if resp.Diagnostics.HasError() {
				return
			}
		}
...
func (r *Ipv6sharednetworkResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Ipv6sharednetwork: %s", err))
	}
}
