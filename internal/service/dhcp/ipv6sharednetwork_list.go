...
var (
	_ list.ListResource                   = &Ipv6sharednetworkList{}
	_ list.ListResourceWithConfigure      = &Ipv6sharednetworkList{}
	_ list.ListResourceWithValidateConfig = &Ipv6sharednetworkList{}
)

func NewIpv6sharednetworkList() list.ListResource {
	return &Ipv6sharednetworkList{}
}

type Ipv6sharednetworkList struct {
	backend core.BackendType
	service coresvc.Ipv6sharednetworkService
}

type Ipv6sharednetworkListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *Ipv6sharednetworkList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ipv6_sharednetwork"
}

func (l *Ipv6sharednetworkList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6sharednetworkService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6sharednetworkList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6sharednetwork from the NIOS backend.",
...
func (l *Ipv6sharednetworkList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6sharednetworkListModel
...
func (l *Ipv6sharednetworkList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6sharednetworkListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ipv6_sharednetwork list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Ipv6sharednetwork
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6sharednetwork, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6sharednetwork, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6sharednetwork records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
