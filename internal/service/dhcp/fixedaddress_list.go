...
var (
	_ list.ListResource                   = &FixedaddressList{}
	_ list.ListResourceWithConfigure      = &FixedaddressList{}
	_ list.ListResourceWithValidateConfig = &FixedaddressList{}
)
...
func (l *FixedaddressList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_fixed_address"
}

func (l *FixedaddressList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewFixedaddressService(l.backend, client.NIOS, client.UDDI)
}

func (l *FixedaddressList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Fixedaddress from both the NIOS and UDDI backends.",
...
func (l *FixedaddressList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *FixedaddressList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_fixed_address list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Fixedaddress
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Fixedaddress, string, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Fixedaddress records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
