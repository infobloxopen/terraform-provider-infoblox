...
var (
	_ list.ListResource                   = &Ipv6rangetemplateList{}
	_ list.ListResourceWithConfigure      = &Ipv6rangetemplateList{}
	_ list.ListResourceWithValidateConfig = &Ipv6rangetemplateList{}
)

func NewIpv6rangetemplateList() list.ListResource {
	return &Ipv6rangetemplateList{}
}

type Ipv6rangetemplateList struct {
	backend core.BackendType
	service coresvc.Ipv6rangetemplateService
}

type Ipv6rangetemplateListModel struct {
	Filters types.Map `tfsdk:"filters"`
}

func (l *Ipv6rangetemplateList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ipv6_range_template"
}

func (l *Ipv6rangetemplateList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6rangetemplateService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6rangetemplateList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6rangetemplate from the NIOS backend.",
...
func (l *Ipv6rangetemplateList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6rangetemplateListModel
...
func (l *Ipv6rangetemplateList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6rangetemplateListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ipv6_range_template list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Ipv6rangetemplate
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6rangetemplate, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6rangetemplate, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6rangetemplate records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
