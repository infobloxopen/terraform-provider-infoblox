...
// FixedaddressCloudInfoModel is the Terraform model for FixedaddressCloudInfo
...
// FixedaddressCloudInfoAttrTypes contains the attribute types for FixedaddressCloudInfoModel
...
// FixedaddressCloudInfoResourceSchemaAttributes contains the schema attributes for FixedaddressCloudInfoModel
...
// ExpandFixedaddressCloudInfo converts a Terraform Object to SDK type
func ExpandFixedaddressCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.FixedaddressCloudInfo {
...
func (m *FixedaddressCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.FixedaddressCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdhcp.FixedaddressCloudInfo{
...
// FlattenFixedaddressCloudInfo converts an SDK type to Terraform Object
func FlattenFixedaddressCloudInfo(ctx context.Context, from *niosdhcp.FixedaddressCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *FixedaddressCloudInfoModel) Flatten(ctx context.Context, from *niosdhcp.FixedaddressCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
