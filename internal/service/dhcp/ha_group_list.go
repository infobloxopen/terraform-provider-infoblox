...
var (
	_ list.ListResource                   = &HaGroupList{}
	_ list.ListResourceWithConfigure      = &HaGroupList{}
	_ list.ListResourceWithValidateConfig = &HaGroupList{}
)

func NewHaGroupList() list.ListResource {
	return &HaGroupList{}
}
...
type HaGroupListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *HaGroupList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ha_group"
}

func (l *HaGroupList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewHaGroupService(l.backend, client.NIOS, client.UDDI)
}

func (l *HaGroupList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Lists Infoblox DHCP HA Groups.",
...
func (l *HaGroupList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data HaGroupListModel
...
func (l *HaGroupList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data HaGroupListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ha_group list: req.Limit=%d backend=%s includeResource=%t",
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.HaGroup, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.HaGroup, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list HaGroup records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
