...
// FixedaddressOptionsModel is the Terraform model for FixedaddressOptions
...
// FixedaddressOptionsAttrTypes contains the attribute types for FixedaddressOptionsModel
...
// FixedaddressOptionsResourceSchemaAttributes contains the schema attributes for FixedaddressOptionsModel
...
// ExpandFixedaddressOptions converts a Terraform Object to SDK type
func ExpandFixedaddressOptions(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.FixedaddressOptions {
...
func (m *FixedaddressOptionsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.FixedaddressOptions {
	if m == nil {
		return nil
	}
	to := &niosdhcp.FixedaddressOptions{
...
// FlattenFixedaddressOptions converts an SDK type to Terraform Object
func FlattenFixedaddressOptions(ctx context.Context, from *niosdhcp.FixedaddressOptions, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *FixedaddressOptionsModel) Flatten(ctx context.Context, from *niosdhcp.FixedaddressOptions, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
