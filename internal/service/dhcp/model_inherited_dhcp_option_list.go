...
func ExpandInheritedDHCPOptionList(ctx context.Context, o types.Object, diags *diag.Diagnostics) *uddidhcp.InheritedDHCPOptionList {
...
func (m *InheritedDHCPOptionListModel) Expand(ctx context.Context, diags *diag.Diagnostics) *uddidhcp.InheritedDHCPOptionList {
	if m == nil {
		return nil
	}
	to := &uddidhcp.InheritedDHCPOptionList{
...
func FlattenInheritedDHCPOptionList(ctx context.Context, from *uddidhcp.InheritedDHCPOptionList, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *InheritedDHCPOptionListModel) Flatten(ctx context.Context, from *uddidhcp.InheritedDHCPOptionList, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
