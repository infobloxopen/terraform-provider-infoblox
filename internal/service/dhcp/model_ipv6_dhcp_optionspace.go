...
func (m *UDDIIpv6DhcpOptionspaceModel) Expand(ctx context.Context, diags *diag.Diagnostics) *coremodel.UDDIIpv6DhcpOptionspaceExt {
	return &coremodel.UDDIIpv6DhcpOptionspaceExt{
