...
// RangeOptionsModel is the Terraform model for RangeOptions
...
// RangeOptionsAttrTypes contains the attribute types for RangeOptionsModel
...
// RangeOptionsResourceSchemaAttributes contains the schema attributes for RangeOptionsModel
...
// ExpandRangeOptions converts a Terraform Object to SDK type
func ExpandRangeOptions(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.RangeOptions {
...
func (m *RangeOptionsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.RangeOptions {
	if m == nil {
		return nil
	}
	to := &niosdhcp.RangeOptions{
...
// FlattenRangeOptions converts an SDK type to Terraform Object
func FlattenRangeOptions(ctx context.Context, from *niosdhcp.RangeOptions, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RangeOptionsModel) Flatten(ctx context.Context, from *niosdhcp.RangeOptions, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
