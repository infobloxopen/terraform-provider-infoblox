...
var (
	_ list.ListResource                   = &RangetemplateList{}
	_ list.ListResourceWithConfigure      = &RangetemplateList{}
	_ list.ListResourceWithValidateConfig = &RangetemplateList{}
)

func NewRangetemplateList() list.ListResource {
	return &RangetemplateList{}
}
...
type RangetemplateListModel struct {
...
func (l *RangetemplateList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRangetemplateService(l.backend, client.NIOS, client.UDDI)
}

func (l *RangetemplateList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Rangetemplate from the NIOS backend.",
...
func (l *RangetemplateList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RangetemplateListModel
...
func (l *RangetemplateList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RangetemplateListModel
	...
	var records []*coremodel.Rangetemplate
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Rangetemplate, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Rangetemplate, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Rangetemplate records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
