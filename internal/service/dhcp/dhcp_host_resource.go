...
var (
	...
	_ resource.ResourceWithValidateConfig = &DhcpHostResource{}
	_ resource.ResourceWithConfigure      = &DhcpHostResource{}
	_ resource.ResourceWithImportState    = &DhcpHostResource{}
	_ resource.ResourceWithIdentity       = &DhcpHostResource{}
)
...
func (r *DhcpHostResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *DhcpHostResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox DhcpHost in the UDDI backend.",
		Attributes:          DhcpHostResourceSchemaAttributes,
	}
}
...
func (r *DhcpHostResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewDhcpHostService(r.backend, client.NIOS, client.UDDI)
}

func (r *DhcpHostResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.DhcpHost](r.backend, op)
}

func (r *DhcpHostResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data DhcpHostModel
	...
	ValidateDhcpHost(ctx, data, resp)
}
...
func (r *DhcpHostResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create DhcpHost: %s", err))
		return
	}
...
func (r *DhcpHostResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read DhcpHost: %s", err))
		return
	}
...
func (r *DhcpHostResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update DhcpHost: %s", err))
		return
	}
...
func (r *DhcpHostResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete DhcpHost: %s", err))
	}
}
