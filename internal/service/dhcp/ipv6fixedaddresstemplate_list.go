...
var (
	_ list.ListResource                   = &Ipv6fixedaddresstemplateList{}
	_ list.ListResourceWithConfigure      = &Ipv6fixedaddresstemplateList{}
	_ list.ListResourceWithValidateConfig = &Ipv6fixedaddresstemplateList{}
)

func NewIpv6fixedaddresstemplateList() list.ListResource {
	return &Ipv6fixedaddresstemplateList{}
}

type Ipv6fixedaddresstemplateList struct {
	backend core.BackendType
	service coresvc.Ipv6fixedaddresstemplateService
}

type Ipv6fixedaddresstemplateListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *Ipv6fixedaddresstemplateList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ipv6_fixed_address_template"
}

func (l *Ipv6fixedaddresstemplateList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6fixedaddresstemplateService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6fixedaddresstemplateList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6fixedaddresstemplate from the NIOS backend.",
...
func (l *Ipv6fixedaddresstemplateList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6fixedaddresstemplateListModel
...
func (l *Ipv6fixedaddresstemplateList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6fixedaddresstemplateListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ipv6_fixed_address_template list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Ipv6fixedaddresstemplate
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6fixedaddresstemplate, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6fixedaddresstemplate, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6fixedaddresstemplate records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
