...
var (
	_ resource.Resource                   = &Ipv6fixedaddressResource{}
	_ resource.ResourceWithValidateConfig = &Ipv6fixedaddressResource{}
	_ resource.ResourceWithConfigure      = &Ipv6fixedaddressResource{}
	_ resource.ResourceWithImportState    = &Ipv6fixedaddressResource{}
	_ resource.ResourceWithIdentity       = &Ipv6fixedaddressResource{}
)
...
func (r *Ipv6fixedaddressResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *Ipv6fixedaddressResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Ipv6fixedaddress in both NIOS and UDDI backends.",
		Attributes:          Ipv6fixedaddressResourceSchemaAttributes,
	}
}

func (r *Ipv6fixedaddressResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewIpv6fixedaddressService(r.backend, client.NIOS, client.UDDI)
}

func (r *Ipv6fixedaddressResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Ipv6fixedaddress](r.backend, op)
}
...
func (r *Ipv6fixedaddressResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateIpv6fixedaddress(ctx, data, resp)
}
...
func (r *Ipv6fixedaddressResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if r.backend == core.BackendNIOS {
		nios := flex.ExpandNestedObject[NIOSIpv6fixedaddressModel](ctx, data.NIOS, &resp.Diagnostics)
		if nios == nil {
			nios = &NIOSIpv6fixedaddressModel{}
		}
		nios.ExtAttrs = flex.SetInternalID(ctx, nios.ExtAttrs, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
		data.NIOS = flex.FlattenNestedObject(ctx, nios, NIOSIpv6fixedaddressAttrTypes, &resp.Diagnostics)
	}
	...
	if r.backend == core.BackendNIOS {
		ApplyIpv6fixedaddressNIOSUseFlags(ctx, req.Config, obj, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
	}
	...
	var (
		apiResp  *coremodel.Ipv6fixedaddress
	...
	err := retry.Do(ctx, r.retryPolicy(retry.OpCreate), func(ctx context.Context) (int, error) {
		...
		apiResp, httpResp, apiErr = r.service.Create(ctx, obj, &core.Options{
			...
			Inherit:      Ipv6fixedaddressInheritanceType,
		})
		if httpResp != nil {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Ipv6fixedaddress: %s", err))
		return
	}
...
func (r *Ipv6fixedaddressResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Ipv6fixedaddress: %s", err))
		return
	}
	...
	if r.backend == core.BackendNIOS && associateInternalId == nil && apiResp.NIOS != nil {
		...
		stateNIOS := flex.ExpandNestedObject[NIOSIpv6fixedaddressModel](ctx, data.NIOS, &resp.Diagnostics)
		if stateNIOS == nil || stateNIOS.ExtAttrsAll.IsNull() || stateNIOS.ExtAttrsAll.IsUnknown() {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read Ipv6fixedaddress because the internal ID (from ext_attrs_all) is missing or invalid.",
			)
			return
		}
...
func (r *Ipv6fixedaddressResource) ReadByExtAttrs(ctx context.Context, data *Ipv6fixedaddressModel, resp *resource.ReadResponse) bool {
	...
	var (
		records  []*coremodel.Ipv6fixedaddress
		httpResp *http.Response
	)
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to search Ipv6fixedaddress by extattrs: %s", err))
		return true
	}
...
func (r *Ipv6fixedaddressResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if r.backend == core.BackendNIOS {
		...
		planNIOS := flex.ExpandNestedObject[NIOSIpv6fixedaddressModel](ctx, data.NIOS, &resp.Diagnostics)
		stateNIOS := flex.ExpandNestedObject[NIOSIpv6fixedaddressModel](ctx, stateNIOSObj, &resp.Diagnostics)
		if planNIOS == nil {
			planNIOS = &NIOSIpv6fixedaddressModel{}
		}
		...
		data.NIOS = flex.FlattenNestedObject(ctx, planNIOS, NIOSIpv6fixedaddressAttrTypes, &resp.Diagnostics)
	}
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Ipv6fixedaddress: %s", err))
		return
	}

	// Restore the plan ext_attrs (without inherited EAs) so Flatten preserves the user's input
	if r.backend == core.BackendNIOS {
		niosObj := flex.ExpandNestedObject[NIOSIpv6fixedaddressModel](ctx, data.NIOS, &resp.Diagnostics)
		if niosObj != nil {
			niosObj.ExtAttrs = planExtAttrs
			data.NIOS = flex.FlattenNestedObject(ctx, niosObj, NIOSIpv6fixedaddressAttrTypes, &resp.Diagnostics)
			if resp.Diagnostics.HasError() {
				return
			}
		}
...
func (r *Ipv6fixedaddressResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Ipv6fixedaddress: %s", err))
	}
}
