...
var (
	_ list.ListResource                   = &Ipv6DhcpOptionspaceList{}
	_ list.ListResourceWithConfigure      = &Ipv6DhcpOptionspaceList{}
	_ list.ListResourceWithValidateConfig = &Ipv6DhcpOptionspaceList{}
)

func NewIpv6DhcpOptionspaceList() list.ListResource {
	return &Ipv6DhcpOptionspaceList{}
}

type Ipv6DhcpOptionspaceList struct {
	backend core.BackendType
	service coresvc.Ipv6DhcpOptionspaceService
}

type Ipv6DhcpOptionspaceListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *Ipv6DhcpOptionspaceList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ipv6_dhcp_optionspace"
}

func (l *Ipv6DhcpOptionspaceList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6DhcpOptionspaceService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6DhcpOptionspaceList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6DhcpOptionspace from both the NIOS and UDDI backends.",
...
func (l *Ipv6DhcpOptionspaceList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6DhcpOptionspaceListModel
...
func (l *Ipv6DhcpOptionspaceList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6DhcpOptionspaceListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ipv6_dhcp_optionspace list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Ipv6DhcpOptionspace
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6DhcpOptionspace, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6DhcpOptionspace, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6DhcpOptionspace records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
