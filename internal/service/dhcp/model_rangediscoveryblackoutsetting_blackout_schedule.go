...
// RangediscoveryblackoutsettingBlackoutScheduleModel is the Terraform model for RangediscoveryblackoutsettingBlackoutSchedule
...
// RangediscoveryblackoutsettingBlackoutScheduleAttrTypes contains the attribute types for RangediscoveryblackoutsettingBlackoutScheduleModel
...
// RangediscoveryblackoutsettingBlackoutScheduleResourceSchemaAttributes contains the schema attributes for RangediscoveryblackoutsettingBlackoutScheduleModel
...
// ExpandRangediscoveryblackoutsettingBlackoutSchedule converts a Terraform Object to SDK type
func ExpandRangediscoveryblackoutsettingBlackoutSchedule(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.RangediscoveryblackoutsettingBlackoutSchedule {
...
func (m *RangediscoveryblackoutsettingBlackoutScheduleModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.RangediscoveryblackoutsettingBlackoutSchedule {
	if m == nil {
		return nil
	}
	to := &niosdhcp.RangediscoveryblackoutsettingBlackoutSchedule{
...
// FlattenRangediscoveryblackoutsettingBlackoutSchedule converts an SDK type to Terraform Object
func FlattenRangediscoveryblackoutsettingBlackoutSchedule(ctx context.Context, from *niosdhcp.RangediscoveryblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RangediscoveryblackoutsettingBlackoutScheduleModel) Flatten(ctx context.Context, from *niosdhcp.RangediscoveryblackoutsettingBlackoutSchedule, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
