...
// FixedaddressMsOptionsModel is the Terraform model for FixedaddressMsOptions
...
// FixedaddressMsOptionsAttrTypes contains the attribute types for FixedaddressMsOptionsModel
...
// FixedaddressMsOptionsResourceSchemaAttributes contains the schema attributes for FixedaddressMsOptionsModel
...
// ExpandFixedaddressMsOptions converts a Terraform Object to SDK type
func ExpandFixedaddressMsOptions(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.FixedaddressMsOptions {
...
func (m *FixedaddressMsOptionsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.FixedaddressMsOptions {
	if m == nil {
		return nil
	}
	to := &niosdhcp.FixedaddressMsOptions{
...
// FlattenFixedaddressMsOptions converts an SDK type to Terraform Object
func FlattenFixedaddressMsOptions(ctx context.Context, from *niosdhcp.FixedaddressMsOptions, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *FixedaddressMsOptionsModel) Flatten(ctx context.Context, from *niosdhcp.FixedaddressMsOptions, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
