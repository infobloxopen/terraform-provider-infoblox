...
var (
	_ resource.Resource                   = &DhcpOptiondefinitionResource{}
	_ resource.ResourceWithValidateConfig = &DhcpOptiondefinitionResource{}
	_ resource.ResourceWithConfigure      = &DhcpOptiondefinitionResource{}
	_ resource.ResourceWithImportState    = &DhcpOptiondefinitionResource{}
	_ resource.ResourceWithIdentity       = &DhcpOptiondefinitionResource{}
)
...
func (r *DhcpOptiondefinitionResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *DhcpOptiondefinitionResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *DhcpOptiondefinitionResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox DhcpOptiondefinition in both NIOS and UDDI backends.",
		Attributes:          DhcpOptiondefinitionResourceSchemaAttributes,
	}
}

func (r *DhcpOptiondefinitionResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewDhcpOptiondefinitionService(r.backend, client.NIOS, client.UDDI)
}

func (r *DhcpOptiondefinitionResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.DhcpOptiondefinition](r.backend, op)
}

func (r *DhcpOptiondefinitionResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateDhcpOptiondefinition(ctx, data, resp)
}
...
func (r *DhcpOptiondefinitionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.DhcpOptiondefinition
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create DhcpOptiondefinition: %s", err))
		return
	}
...
func (r *DhcpOptiondefinitionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read DhcpOptiondefinition: %s", err))
		return
	}
...
func (r *DhcpOptiondefinitionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update DhcpOptiondefinition: %s", err))
		return
	}
...
func (r *DhcpOptiondefinitionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete DhcpOptiondefinition: %s", err))
	}
}
