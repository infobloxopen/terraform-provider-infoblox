...
// FilteroptionOptionListModel is the Terraform model for FilteroptionOptionList
...
// FilteroptionOptionListAttrTypes contains the attribute types for FilteroptionOptionListModel
...
// FilteroptionOptionListResourceSchemaAttributes contains the schema attributes for FilteroptionOptionListModel
...
// ExpandFilteroptionOptionList converts a Terraform Object to SDK type
func ExpandFilteroptionOptionList(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.FilteroptionOptionList {
...
func (m *FilteroptionOptionListModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.FilteroptionOptionList {
	if m == nil {
		return nil
	}
	to := &niosdhcp.FilteroptionOptionList{
...
// FlattenFilteroptionOptionList converts an SDK type to Terraform Object
func FlattenFilteroptionOptionList(ctx context.Context, from *niosdhcp.FilteroptionOptionList, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *FilteroptionOptionListModel) Flatten(ctx context.Context, from *niosdhcp.FilteroptionOptionList, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
