...
func ExpandInheritedDHCPOption(ctx context.Context, o types.Object, diags *diag.Diagnostics) *uddidhcp.InheritedDHCPOption {
...
func (m *InheritedDHCPOptionModel) Expand(ctx context.Context, diags *diag.Diagnostics) *uddidhcp.InheritedDHCPOption {
	if m == nil {
		return nil
	}
...
func FlattenInheritedDHCPOption(ctx context.Context, from *uddidhcp.InheritedDHCPOption, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *InheritedDHCPOptionModel) Flatten(ctx context.Context, from *uddidhcp.InheritedDHCPOption, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
