...
func ExpandInheritanceInheritedString(ctx context.Context, o types.Object, diags *diag.Diagnostics) *uddidhcp.InheritanceInheritedString {
...
func (m *InheritanceInheritedStringModel) Expand(ctx context.Context, diags *diag.Diagnostics) *uddidhcp.InheritanceInheritedString {
	if m == nil {
		return nil
	}
...
func FlattenInheritanceInheritedString(ctx context.Context, from *uddidhcp.InheritanceInheritedString, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *InheritanceInheritedStringModel) Flatten(ctx context.Context, from *uddidhcp.InheritanceInheritedString, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
