...
func ExpandOptionItem(ctx context.Context, o types.Object, diags *diag.Diagnostics) *uddidhcp.OptionItem {
...
func (m *OptionItemModel) Expand(ctx context.Context, diags *diag.Diagnostics) *uddidhcp.OptionItem {
	if m == nil {
		return nil
	}
...
func FlattenOptionItem(ctx context.Context, from *uddidhcp.OptionItem, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *OptionItemModel) Flatten(ctx context.Context, from *uddidhcp.OptionItem, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
