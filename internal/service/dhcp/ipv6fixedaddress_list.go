...
var (
	_ list.ListResource                   = &Ipv6fixedaddressList{}
	_ list.ListResourceWithConfigure      = &Ipv6fixedaddressList{}
	_ list.ListResourceWithValidateConfig = &Ipv6fixedaddressList{}
)

func NewIpv6fixedaddressList() list.ListResource {
	return &Ipv6fixedaddressList{}
}

type Ipv6fixedaddressList struct {
	backend core.BackendType
	service coresvc.Ipv6fixedaddressService
}

type Ipv6fixedaddressListModel struct {
...
func (l *Ipv6fixedaddressList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6fixedaddressService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6fixedaddressList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6fixedaddress from both the NIOS and UDDI backends.",
...
func (l *Ipv6fixedaddressList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6fixedaddressListModel
...
func (l *Ipv6fixedaddressList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6fixedaddressListModel
	...
	var records []*coremodel.Ipv6fixedaddress
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6fixedaddress, string, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6fixedaddress records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
