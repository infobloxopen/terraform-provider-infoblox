...
var (
	_ list.ListResource                   = &DhcpHostList{}
	_ list.ListResourceWithConfigure      = &DhcpHostList{}
	_ list.ListResourceWithValidateConfig = &DhcpHostList{}
)

func NewDhcpHostList() list.ListResource {
	return &DhcpHostList{}
}
...
type DhcpHostListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *DhcpHostList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dhcp_host"
}

func (l *DhcpHostList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewDhcpHostService(l.backend, client.NIOS, client.UDDI)
}

func (l *DhcpHostList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox DhcpHost from the UDDI backend.",
...
func (l *DhcpHostList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data DhcpHostListModel
...
func (l *DhcpHostList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data DhcpHostListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_dhcp_host list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.DhcpHost
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.DhcpHost, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.DhcpHost, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list DhcpHost records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
