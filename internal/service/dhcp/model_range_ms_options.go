...
// RangeMsOptionsModel is the Terraform model for RangeMsOptions
...
// RangeMsOptionsAttrTypes contains the attribute types for RangeMsOptionsModel
...
// RangeMsOptionsResourceSchemaAttributes contains the schema attributes for RangeMsOptionsModel
...
// ExpandRangeMsOptions converts a Terraform Object to SDK type
func ExpandRangeMsOptions(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.RangeMsOptions {
...
func (m *RangeMsOptionsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.RangeMsOptions {
	if m == nil {
		return nil
	}
	to := &niosdhcp.RangeMsOptions{
...
// FlattenRangeMsOptions converts an SDK type to Terraform Object
func FlattenRangeMsOptions(ctx context.Context, from *niosdhcp.RangeMsOptions, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RangeMsOptionsModel) Flatten(ctx context.Context, from *niosdhcp.RangeMsOptions, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
