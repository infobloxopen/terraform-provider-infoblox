...
var (
	_ list.ListResource                   = &Ipv6DhcpOptiondefinitionList{}
	_ list.ListResourceWithConfigure      = &Ipv6DhcpOptiondefinitionList{}
	_ list.ListResourceWithValidateConfig = &Ipv6DhcpOptiondefinitionList{}
)

func NewIpv6DhcpOptiondefinitionList() list.ListResource {
	return &Ipv6DhcpOptiondefinitionList{}
}

type Ipv6DhcpOptiondefinitionList struct {
...
func (l *Ipv6DhcpOptiondefinitionList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6DhcpOptiondefinitionService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6DhcpOptiondefinitionList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6DhcpOptiondefinition from both the NIOS and UDDI backends.",
...
func (l *Ipv6DhcpOptiondefinitionList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6DhcpOptiondefinitionListModel
...
func (l *Ipv6DhcpOptiondefinitionList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ipv6_dhcp_optiondefinition list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.Ipv6DhcpOptiondefinition
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6DhcpOptiondefinition, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6DhcpOptiondefinition, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6DhcpOptiondefinition records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
