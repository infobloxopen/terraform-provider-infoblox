...
var (
	_ resource.Resource                   = &FederatedRealmResource{}
	_ resource.ResourceWithValidateConfig = &FederatedRealmResource{}
	_ resource.ResourceWithConfigure      = &FederatedRealmResource{}
	_ resource.ResourceWithImportState    = &FederatedRealmResource{}
	_ resource.ResourceWithIdentity       = &FederatedRealmResource{}
)
...
func (r *FederatedRealmResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *FederatedRealmResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *FederatedRealmResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox FederatedRealm in the UDDI backend.",
		Attributes:          FederatedRealmResourceSchemaAttributes,
	}
}

func (r *FederatedRealmResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewFederatedRealmService(r.backend, client.NIOS, client.UDDI)
}

func (r *FederatedRealmResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.FederatedRealm](r.backend, op)
}

func (r *FederatedRealmResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateFederatedRealm(ctx, data, resp)
}
...
func (r *FederatedRealmResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.FederatedRealm
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create FederatedRealm: %s", err))
		return
	}
...
func (r *FederatedRealmResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read FederatedRealm: %s", err))
		return
	}
...
func (r *FederatedRealmResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update FederatedRealm: %s", err))
		return
	}
...
func (r *FederatedRealmResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete FederatedRealm: %s", err))
	}
}
