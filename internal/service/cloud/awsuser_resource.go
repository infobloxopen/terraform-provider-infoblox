...
var (
	_ resource.Resource                   = &AwsuserResource{}
	_ resource.ResourceWithValidateConfig = &AwsuserResource{}
	_ resource.ResourceWithConfigure      = &AwsuserResource{}
	_ resource.ResourceWithImportState    = &AwsuserResource{}
	_ resource.ResourceWithIdentity       = &AwsuserResource{}
)
...
func (r *AwsuserResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *AwsuserResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Awsuser in the NIOS backend.",
		Attributes:          AwsuserResourceSchemaAttributes,
	}
}

func (r *AwsuserResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewAwsuserService(r.backend, client.NIOS, client.UDDI)
}

func (r *AwsuserResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Awsuser](r.backend, op)
}

func (r *AwsuserResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
...
func (r *AwsuserResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Awsuser: %s", err))
		return
	}
...
func (r *AwsuserResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Awsuser: %s", err))
		return
	}
...
func (r *AwsuserResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Awsuser: %s", err))
		return
	}
...
func (r *AwsuserResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Awsuser: %s", err))
	}
}
