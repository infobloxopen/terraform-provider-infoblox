...
var (
	_ list.ListResource                   = &AwsuserList{}
	_ list.ListResourceWithConfigure      = &AwsuserList{}
	_ list.ListResourceWithValidateConfig = &AwsuserList{}
)

func NewAwsuserList() list.ListResource {
	return &AwsuserList{}
}
...
func (l *AwsuserList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewAwsuserService(l.backend, client.NIOS, client.UDDI)
}

func (l *AwsuserList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Awsuser from the NIOS backend.",
...
func (l *AwsuserList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data AwsuserListModel
...
func (l *AwsuserList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data AwsuserListModel
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Awsuser, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Awsuser, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Awsuser records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
