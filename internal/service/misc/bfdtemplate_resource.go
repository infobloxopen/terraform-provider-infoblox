...
var (
	...
	_ resource.ResourceWithValidateConfig = &BfdtemplateResource{}
	_ resource.ResourceWithConfigure      = &BfdtemplateResource{}
	_ resource.ResourceWithImportState    = &BfdtemplateResource{}
	_ resource.ResourceWithIdentity       = &BfdtemplateResource{}
)
...
func (r *BfdtemplateResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *BfdtemplateResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Bfdtemplate in the NIOS backend.",
		Attributes:          BfdtemplateResourceSchemaAttributes,
	}
}

func (r *BfdtemplateResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewBfdtemplateService(r.backend, client.NIOS, client.UDDI)
}

func (r *BfdtemplateResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Bfdtemplate](r.backend, op)
}

func (r *BfdtemplateResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateBfdtemplate(ctx, data, resp)
}
...
func (r *BfdtemplateResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Bfdtemplate: %s", err))
		return
	}
...
func (r *BfdtemplateResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Bfdtemplate: %s", err))
		return
	}
...
func (r *BfdtemplateResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Bfdtemplate: %s", err))
		return
	}
...
func (r *BfdtemplateResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Bfdtemplate: %s", err))
	}
}
