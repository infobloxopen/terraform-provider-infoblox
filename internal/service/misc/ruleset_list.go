...
var (
	_ list.ListResource                   = &RulesetList{}
	_ list.ListResourceWithConfigure      = &RulesetList{}
	_ list.ListResourceWithValidateConfig = &RulesetList{}
)

func NewRulesetList() list.ListResource {
	return &RulesetList{}
}
...
type RulesetListModel struct {
	Filters types.Map `tfsdk:"filters"`
}

func (l *RulesetList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ruleset"
}

func (l *RulesetList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRulesetService(l.backend, client.NIOS, client.UDDI)
}

func (l *RulesetList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ruleset from the NIOS backend.",
...
func (l *RulesetList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RulesetListModel
...
func (l *RulesetList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RulesetListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_ruleset list: req.Limit=%d backend=%s includeResource=%t",
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ruleset, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ruleset, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ruleset records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
