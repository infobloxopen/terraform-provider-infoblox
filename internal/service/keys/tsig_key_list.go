...
var (
	_ list.ListResource                   = &TsigKeyList{}
	_ list.ListResourceWithConfigure      = &TsigKeyList{}
	_ list.ListResourceWithValidateConfig = &TsigKeyList{}
)

func NewTsigKeyList() list.ListResource {
	return &TsigKeyList{}
}
...
type TsigKeyListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *TsigKeyList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tsig_key"
}

func (l *TsigKeyList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewTsigKeyService(l.backend, client.NIOS, client.UDDI)
}

func (l *TsigKeyList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox TsigKey from the UDDI backend.",
...
func (l *TsigKeyList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data TsigKeyListModel
...
func (l *TsigKeyList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data TsigKeyListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_tsig_key list: req.Limit=%d backend=%s includeResource=%t",
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.TsigKey, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.TsigKey, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list TsigKey records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
