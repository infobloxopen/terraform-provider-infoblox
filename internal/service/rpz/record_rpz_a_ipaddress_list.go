...
var (
	_ list.ListResource                   = &RecordRpzAIpaddressList{}
	_ list.ListResourceWithConfigure      = &RecordRpzAIpaddressList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzAIpaddressList{}
)

func NewRecordRpzAIpaddressList() list.ListResource {
	return &RecordRpzAIpaddressList{}
}

type RecordRpzAIpaddressList struct {
	backend core.BackendType
	service coresvc.RecordRpzAIpaddressService
}

type RecordRpzAIpaddressListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzAIpaddressList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_a_ipaddress"
}

func (l *RecordRpzAIpaddressList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzAIpaddressService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzAIpaddressList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzAIpaddress from the NIOS backend.",
...
func (l *RecordRpzAIpaddressList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzAIpaddressListModel
...
func (l *RecordRpzAIpaddressList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzAIpaddressListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_a_ipaddress list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzAIpaddress
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzAIpaddress, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzAIpaddress, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzAIpaddress records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
