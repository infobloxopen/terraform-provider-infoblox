...
var (
	_ list.ListResource                   = &RecordRpzCnameList{}
	_ list.ListResourceWithConfigure      = &RecordRpzCnameList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzCnameList{}
)

func NewRecordRpzCnameList() list.ListResource {
	return &RecordRpzCnameList{}
}

type RecordRpzCnameList struct {
	backend core.BackendType
	service coresvc.RecordRpzCnameService
}

type RecordRpzCnameListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzCnameList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_cname"
}

func (l *RecordRpzCnameList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzCnameService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzCnameList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzCname from the NIOS backend.",
...
func (l *RecordRpzCnameList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzCnameListModel
...
func (l *RecordRpzCnameList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzCnameListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_cname list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzCname
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzCname, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzCname, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzCname records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
