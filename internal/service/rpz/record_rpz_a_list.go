...
var (
	_ list.ListResource                   = &RecordRpzAList{}
	_ list.ListResourceWithConfigure      = &RecordRpzAList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzAList{}
)

func NewRecordRpzAList() list.ListResource {
	return &RecordRpzAList{}
}

type RecordRpzAList struct {
	backend core.BackendType
	service coresvc.RecordRpzAService
}

type RecordRpzAListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzAList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_a"
}

func (l *RecordRpzAList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzAService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzAList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzA from the NIOS backend.",
...
func (l *RecordRpzAList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzAListModel
...
func (l *RecordRpzAList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzAListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_a list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzA
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzA, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzA, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzA records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
