...
var (
	_ list.ListResource                   = &RecordRpzCnameIpaddressdnList{}
	_ list.ListResourceWithConfigure      = &RecordRpzCnameIpaddressdnList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzCnameIpaddressdnList{}
)

func NewRecordRpzCnameIpaddressdnList() list.ListResource {
	return &RecordRpzCnameIpaddressdnList{}
}

type RecordRpzCnameIpaddressdnList struct {
	backend core.BackendType
	service coresvc.RecordRpzCnameIpaddressdnService
}

type RecordRpzCnameIpaddressdnListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzCnameIpaddressdnList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_cname_ipaddressdn"
}

func (l *RecordRpzCnameIpaddressdnList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzCnameIpaddressdnService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzCnameIpaddressdnList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzCnameIpaddressdn from the NIOS backend.",
...
func (l *RecordRpzCnameIpaddressdnList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzCnameIpaddressdnListModel
...
func (l *RecordRpzCnameIpaddressdnList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzCnameIpaddressdnListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_cname_ipaddressdn list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzCnameIpaddressdn
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzCnameIpaddressdn, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzCnameIpaddressdn, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzCnameIpaddressdn records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
