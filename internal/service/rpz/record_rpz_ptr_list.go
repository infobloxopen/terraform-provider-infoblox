...
var (
	_ list.ListResource                   = &RecordRpzPtrList{}
	_ list.ListResourceWithConfigure      = &RecordRpzPtrList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzPtrList{}
)

func NewRecordRpzPtrList() list.ListResource {
	return &RecordRpzPtrList{}
}

type RecordRpzPtrList struct {
	backend core.BackendType
	service coresvc.RecordRpzPtrService
}

type RecordRpzPtrListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzPtrList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_ptr"
}

func (l *RecordRpzPtrList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzPtrService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzPtrList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzPtr from the NIOS backend.",
...
func (l *RecordRpzPtrList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzPtrListModel
...
func (l *RecordRpzPtrList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzPtrListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_ptr list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzPtr
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzPtr, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzPtr, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzPtr records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
