...
var (
	_ list.ListResource                   = &RecordRpzTxtList{}
	_ list.ListResourceWithConfigure      = &RecordRpzTxtList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzTxtList{}
)

func NewRecordRpzTxtList() list.ListResource {
	return &RecordRpzTxtList{}
}

type RecordRpzTxtList struct {
	backend core.BackendType
	service coresvc.RecordRpzTxtService
}

type RecordRpzTxtListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzTxtList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_txt"
}

func (l *RecordRpzTxtList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzTxtService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzTxtList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzTxt from the NIOS backend.",
...
func (l *RecordRpzTxtList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzTxtListModel
...
func (l *RecordRpzTxtList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzTxtListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_txt list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzTxt
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzTxt, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzTxt, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzTxt records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
