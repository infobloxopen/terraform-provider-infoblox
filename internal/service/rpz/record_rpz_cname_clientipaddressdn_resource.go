...
var (
	_ resource.Resource                   = &RecordRpzCnameClientipaddressdnResource{}
	_ resource.ResourceWithValidateConfig = &RecordRpzCnameClientipaddressdnResource{}
	_ resource.ResourceWithConfigure      = &RecordRpzCnameClientipaddressdnResource{}
	_ resource.ResourceWithImportState    = &RecordRpzCnameClientipaddressdnResource{}
	_ resource.ResourceWithIdentity       = &RecordRpzCnameClientipaddressdnResource{}
)
...
func (r *RecordRpzCnameClientipaddressdnResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *RecordRpzCnameClientipaddressdnResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *RecordRpzCnameClientipaddressdnResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox RecordRpzCnameClientipaddressdn in the NIOS backend.",
		Attributes:          RecordRpzCnameClientipaddressdnResourceSchemaAttributes,
	}
}

func (r *RecordRpzCnameClientipaddressdnResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewRecordRpzCnameClientipaddressdnService(r.backend, client.NIOS, client.UDDI)
}

func (r *RecordRpzCnameClientipaddressdnResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.RecordRpzCnameClientipaddressdn](r.backend, op)
}

func (r *RecordRpzCnameClientipaddressdnResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateRecordRpzCnameClientipaddressdn(ctx, data, resp)
}
...
func (r *RecordRpzCnameClientipaddressdnResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if r.backend == core.BackendNIOS {
		nios := flex.ExpandNestedObject[NIOSRecordRpzCnameClientipaddressdnModel](ctx, data.NIOS, &resp.Diagnostics)
		if nios == nil {
			nios = &NIOSRecordRpzCnameClientipaddressdnModel{}
		}
		nios.ExtAttrs = flex.SetInternalID(ctx, nios.ExtAttrs, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
		data.NIOS = flex.FlattenNestedObject(ctx, nios, NIOSRecordRpzCnameClientipaddressdnAttrTypes, &resp.Diagnostics)
	}
	...
	if r.backend == core.BackendNIOS {
		ApplyRecordRpzCnameClientipaddressdnNIOSUseFlags(ctx, req.Config, obj, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
	}
	...
	var (
		apiResp  *coremodel.RecordRpzCnameClientipaddressdn
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create RecordRpzCnameClientipaddressdn: %s", err))
		return
	}
...
func (r *RecordRpzCnameClientipaddressdnResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read RecordRpzCnameClientipaddressdn: %s", err))
		return
	}
	...
	if r.backend == core.BackendNIOS && associateInternalId == nil && apiResp.NIOS != nil {
		...
		stateNIOS := flex.ExpandNestedObject[NIOSRecordRpzCnameClientipaddressdnModel](ctx, data.NIOS, &resp.Diagnostics)
		if stateNIOS == nil || stateNIOS.ExtAttrsAll.IsNull() || stateNIOS.ExtAttrsAll.IsUnknown() {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read RecordRpzCnameClientipaddressdn because the internal ID (from ext_attrs_all) is missing or invalid.",
			)
			return
		}
...
func (r *RecordRpzCnameClientipaddressdnResource) ReadByExtAttrs(ctx context.Context, data *RecordRpzCnameClientipaddressdnModel, resp *resource.ReadResponse) bool {
	...
	var (
		records  []*coremodel.RecordRpzCnameClientipaddressdn
		httpResp *http.Response
	)
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to search RecordRpzCnameClientipaddressdn by extattrs: %s", err))
		return true
	}
...
func (r *RecordRpzCnameClientipaddressdnResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if r.backend == core.BackendNIOS {
		...
		planNIOS := flex.ExpandNestedObject[NIOSRecordRpzCnameClientipaddressdnModel](ctx, data.NIOS, &resp.Diagnostics)
		stateNIOS := flex.ExpandNestedObject[NIOSRecordRpzCnameClientipaddressdnModel](ctx, stateNIOSObj, &resp.Diagnostics)
		if planNIOS == nil {
			planNIOS = &NIOSRecordRpzCnameClientipaddressdnModel{}
		}
		...
		data.NIOS = flex.FlattenNestedObject(ctx, planNIOS, NIOSRecordRpzCnameClientipaddressdnAttrTypes, &resp.Diagnostics)
	}
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update RecordRpzCnameClientipaddressdn: %s", err))
		return
	}

	// Restore the plan ext_attrs (without inherited EAs) so Flatten preserves the user's input
	if r.backend == core.BackendNIOS {
		niosObj := flex.ExpandNestedObject[NIOSRecordRpzCnameClientipaddressdnModel](ctx, data.NIOS, &resp.Diagnostics)
		if niosObj != nil {
			niosObj.ExtAttrs = planExtAttrs
			data.NIOS = flex.FlattenNestedObject(ctx, niosObj, NIOSRecordRpzCnameClientipaddressdnAttrTypes, &resp.Diagnostics)
			if resp.Diagnostics.HasError() {
				return
			}
		}
...
func (r *RecordRpzCnameClientipaddressdnResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete RecordRpzCnameClientipaddressdn: %s", err))
	}
}
