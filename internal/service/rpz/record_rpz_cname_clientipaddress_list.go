...
var (
	_ list.ListResource                   = &RecordRpzCnameClientipaddressList{}
	_ list.ListResourceWithConfigure      = &RecordRpzCnameClientipaddressList{}
	_ list.ListResourceWithValidateConfig = &RecordRpzCnameClientipaddressList{}
)

func NewRecordRpzCnameClientipaddressList() list.ListResource {
	return &RecordRpzCnameClientipaddressList{}
}

type RecordRpzCnameClientipaddressList struct {
	backend core.BackendType
	service coresvc.RecordRpzCnameClientipaddressService
}

type RecordRpzCnameClientipaddressListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *RecordRpzCnameClientipaddressList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_rpz_cname_clientipaddress"
}

func (l *RecordRpzCnameClientipaddressList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordRpzCnameClientipaddressService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordRpzCnameClientipaddressList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordRpzCnameClientipaddress from the NIOS backend.",
...
func (l *RecordRpzCnameClientipaddressList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data RecordRpzCnameClientipaddressListModel
...
func (l *RecordRpzCnameClientipaddressList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data RecordRpzCnameClientipaddressListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_rpz_cname_clientipaddress list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordRpzCnameClientipaddress
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordRpzCnameClientipaddress, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordRpzCnameClientipaddress, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordRpzCnameClientipaddress records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
