...
// ZoneAuthExternalSecondariesModel is the Terraform model for ZoneAuthExternalSecondaries
...
// ZoneAuthExternalSecondariesAttrTypes contains the attribute types for ZoneAuthExternalSecondariesModel
...
// ZoneAuthExternalSecondariesResourceSchemaAttributes contains the schema attributes for ZoneAuthExternalSecondariesModel
...
// ExpandZoneAuthExternalSecondaries converts a Terraform Object to SDK type
func ExpandZoneAuthExternalSecondaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneAuthExternalSecondaries {
...
func (m *ZoneAuthExternalSecondariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneAuthExternalSecondaries {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneAuthExternalSecondaries{
...
// FlattenZoneAuthExternalSecondaries converts an SDK type to Terraform Object
func FlattenZoneAuthExternalSecondaries(ctx context.Context, from *niosdns.ZoneAuthExternalSecondaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneAuthExternalSecondariesModel) Flatten(ctx context.Context, from *niosdns.ZoneAuthExternalSecondaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
