...
var (
	_ resource.Resource                   = &ForwardNsgResource{}
	_ resource.ResourceWithValidateConfig = &ForwardNsgResource{}
	_ resource.ResourceWithConfigure      = &ForwardNsgResource{}
	_ resource.ResourceWithImportState    = &ForwardNsgResource{}
	_ resource.ResourceWithIdentity       = &ForwardNsgResource{}
)
...
type ForwardNsgResource struct {
	...
	service coresvc.ForwardNsgService
}

func (r *ForwardNsgResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_forward_nsg"
	resp.ResourceBehavior = resource.ResourceBehavior{
		MutableIdentity: true,
	}
}

func (r *ForwardNsgResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *ForwardNsgResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox ForwardNsg in the UDDI backend.",
		Attributes:          ForwardNsgResourceSchemaAttributes,
	}
}

func (r *ForwardNsgResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewForwardNsgService(r.backend, client.NIOS, client.UDDI)
}

func (r *ForwardNsgResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.ForwardNsg](r.backend, op)
}

func (r *ForwardNsgResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var data ForwardNsgModel
	...
	ValidateForwardNsg(ctx, data, resp)
}
...
func (r *ForwardNsgResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err := retry.Do(ctx, r.retryPolicy(retry.OpCreate), func(ctx context.Context) (int, error) {
		...
		apiResp, httpResp, apiErr = r.service.Create(ctx, obj, &core.Options{
			ReturnFields: ForwardNsgReturnFields,
		})
		if httpResp != nil {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create ForwardNsg: %s", err))
		return
	}
...
func (r *ForwardNsgResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read ForwardNsg: %s", err))
		return
	}
...
func (r *ForwardNsgResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update ForwardNsg: %s", err))
		return
	}
...
func (r *ForwardNsgResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete ForwardNsg: %s", err))
	}
}
