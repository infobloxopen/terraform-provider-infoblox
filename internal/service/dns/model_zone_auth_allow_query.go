...
// ZoneAuthAllowQueryModel is the Terraform model for ZoneAuthAllowQuery
...
// ZoneAuthAllowQueryAttrTypes contains the attribute types for ZoneAuthAllowQueryModel
...
// ZoneAuthAllowQueryResourceSchemaAttributes contains the schema attributes for ZoneAuthAllowQueryModel
...
// ExpandZoneAuthAllowQuery converts a Terraform Object to SDK type
func ExpandZoneAuthAllowQuery(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneAuthAllowQuery {
...
func (m *ZoneAuthAllowQueryModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneAuthAllowQuery {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneAuthAllowQuery{
...
// FlattenZoneAuthAllowQuery converts an SDK type to Terraform Object
func FlattenZoneAuthAllowQuery(ctx context.Context, from *niosdns.ZoneAuthAllowQuery, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneAuthAllowQueryModel) Flatten(ctx context.Context, from *niosdns.ZoneAuthAllowQuery, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
