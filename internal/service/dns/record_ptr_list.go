...
var (
	_ list.ListResource                   = &RecordPtrList{}
	_ list.ListResourceWithConfigure      = &RecordPtrList{}
	_ list.ListResourceWithValidateConfig = &RecordPtrList{}
)
...
func (l *RecordPtrList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_record_ptr"
}

func (l *RecordPtrList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewRecordPtrService(l.backend, client.NIOS, client.UDDI)
}

func (l *RecordPtrList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox RecordPtr from both the NIOS and UDDI backends.",
...
func (l *RecordPtrList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *RecordPtrList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_record_ptr list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.RecordPtr
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.RecordPtr, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.RecordPtr, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list RecordPtr records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
