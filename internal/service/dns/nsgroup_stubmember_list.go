...
var (
	_ list.ListResource                   = &NsgroupStubmemberList{}
	_ list.ListResourceWithConfigure      = &NsgroupStubmemberList{}
	_ list.ListResourceWithValidateConfig = &NsgroupStubmemberList{}
)
...
func (l *NsgroupStubmemberList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_nsgroup_stubmember"
}

func (l *NsgroupStubmemberList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewNsgroupStubmemberService(l.backend, client.NIOS, client.UDDI)
}

func (l *NsgroupStubmemberList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox NsgroupStubmember from the NIOS backend.",
...
func (l *NsgroupStubmemberList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *NsgroupStubmemberList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_nsgroup_stubmember list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.NsgroupStubmember
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.NsgroupStubmember, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.NsgroupStubmember, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list NsgroupStubmember records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
