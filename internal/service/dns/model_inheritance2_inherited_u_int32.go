...
func ExpandInheritance2InheritedUInt32(ctx context.Context, o types.Object, diags *diag.Diagnostics) *uddidns.Inheritance2InheritedUInt32 {
...
func (m *Inheritance2InheritedUInt32Model) Expand(ctx context.Context, diags *diag.Diagnostics) *uddidns.Inheritance2InheritedUInt32 {
	if m == nil {
		return nil
	}
...
func FlattenInheritance2InheritedUInt32(ctx context.Context, from *uddidns.Inheritance2InheritedUInt32, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Inheritance2InheritedUInt32Model) Flatten(ctx context.Context, from *uddidns.Inheritance2InheritedUInt32, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
