...
// ZoneauthgridprimaryPreferredPrimariesModel is the Terraform model for ZoneauthgridprimaryPreferredPrimaries
...
// ZoneauthgridprimaryPreferredPrimariesAttrTypes contains the attribute types for ZoneauthgridprimaryPreferredPrimariesModel
...
// ZoneauthgridprimaryPreferredPrimariesResourceSchemaAttributes contains the schema attributes for ZoneauthgridprimaryPreferredPrimariesModel
...
// ExpandZoneauthgridprimaryPreferredPrimaries converts a Terraform Object to SDK type
func ExpandZoneauthgridprimaryPreferredPrimaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneauthgridprimaryPreferredPrimaries {
...
func (m *ZoneauthgridprimaryPreferredPrimariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneauthgridprimaryPreferredPrimaries {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneauthgridprimaryPreferredPrimaries{
...
// FlattenZoneauthgridprimaryPreferredPrimaries converts an SDK type to Terraform Object
func FlattenZoneauthgridprimaryPreferredPrimaries(ctx context.Context, from *niosdns.ZoneauthgridprimaryPreferredPrimaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneauthgridprimaryPreferredPrimariesModel) Flatten(ctx context.Context, from *niosdns.ZoneauthgridprimaryPreferredPrimaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
