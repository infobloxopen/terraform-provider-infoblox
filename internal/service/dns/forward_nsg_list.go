...
var (
	_ list.ListResource                   = &ForwardNsgList{}
	_ list.ListResourceWithConfigure      = &ForwardNsgList{}
	_ list.ListResourceWithValidateConfig = &ForwardNsgList{}
)

func NewForwardNsgList() list.ListResource {
	return &ForwardNsgList{}
}

type ForwardNsgList struct {
	backend core.BackendType
	service coresvc.ForwardNsgService
}

type ForwardNsgListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *ForwardNsgList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_forward_nsg"
}

func (l *ForwardNsgList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewForwardNsgService(l.backend, client.NIOS, client.UDDI)
}

func (l *ForwardNsgList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox ForwardNsg from the UDDI backend.",
...
func (l *ForwardNsgList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data ForwardNsgListModel
...
func (l *ForwardNsgList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data ForwardNsgListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_forward_nsg list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.ForwardNsg
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.ForwardNsg, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.ForwardNsg, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list ForwardNsg records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
