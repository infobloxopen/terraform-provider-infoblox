...
var (
	_ resource.Resource                   = &AuthNsgResource{}
	_ resource.ResourceWithValidateConfig = &AuthNsgResource{}
	_ resource.ResourceWithConfigure      = &AuthNsgResource{}
	_ resource.ResourceWithImportState    = &AuthNsgResource{}
	_ resource.ResourceWithIdentity       = &AuthNsgResource{}
)
...
func (r *AuthNsgResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *AuthNsgResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *AuthNsgResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewAuthNsgService(r.backend, client.NIOS, client.UDDI)
}

func (r *AuthNsgResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.AuthNsg](r.backend, op)
}
...
func (r *AuthNsgResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create AuthNsg: %s", err))
		return
	}
...
func (r *AuthNsgResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read AuthNsg: %s", err))
		return
	}
...
func (r *AuthNsgResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update AuthNsg: %s", err))
		return
	}
...
func (r *AuthNsgResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete AuthNsg: %s", err))
	}
}
