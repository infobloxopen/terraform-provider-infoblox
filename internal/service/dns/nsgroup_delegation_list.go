...
var (
	_ list.ListResource                   = &NsgroupDelegationList{}
	_ list.ListResourceWithConfigure      = &NsgroupDelegationList{}
	_ list.ListResourceWithValidateConfig = &NsgroupDelegationList{}
)
...
func (l *NsgroupDelegationList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_nsgroup_delegation"
}

func (l *NsgroupDelegationList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewNsgroupDelegationService(l.backend, client.NIOS, client.UDDI)
}

func (l *NsgroupDelegationList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox NsgroupDelegation from the NIOS backend.",
...
func (l *NsgroupDelegationList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *NsgroupDelegationList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_nsgroup_delegation list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.NsgroupDelegation
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.NsgroupDelegation, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.NsgroupDelegation, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list NsgroupDelegation records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
