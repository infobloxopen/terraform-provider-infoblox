...
var (
	_ list.ListResource                   = &SharedrecordAList{}
	_ list.ListResourceWithConfigure      = &SharedrecordAList{}
	_ list.ListResourceWithValidateConfig = &SharedrecordAList{}
)
...
func (l *SharedrecordAList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sharedrecord_a"
}

func (l *SharedrecordAList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewSharedrecordAService(l.backend, client.NIOS, client.UDDI)
}

func (l *SharedrecordAList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox SharedrecordA from the NIOS backend.",
...
func (l *SharedrecordAList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *SharedrecordAList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_sharedrecord_a list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.SharedrecordA
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.SharedrecordA, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.SharedrecordA, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list SharedrecordA records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
