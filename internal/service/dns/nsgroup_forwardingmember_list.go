...
var (
	_ list.ListResource                   = &NsgroupForwardingmemberList{}
	_ list.ListResourceWithConfigure      = &NsgroupForwardingmemberList{}
	_ list.ListResourceWithValidateConfig = &NsgroupForwardingmemberList{}
)
...
func (l *NsgroupForwardingmemberList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_nsgroup_forwardingmember"
}

func (l *NsgroupForwardingmemberList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewNsgroupForwardingmemberService(l.backend, client.NIOS, client.UDDI)
}

func (l *NsgroupForwardingmemberList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox NsgroupForwardingmember from the NIOS backend.",
...
func (l *NsgroupForwardingmemberList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *NsgroupForwardingmemberList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_nsgroup_forwardingmember list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.NsgroupForwardingmember
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.NsgroupForwardingmember, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.NsgroupForwardingmember, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list NsgroupForwardingmember records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
