...
// ZoneStubStubFromModel is the Terraform model for ZoneStubStubFrom
...
// ZoneStubStubFromAttrTypes contains the attribute types for ZoneStubStubFromModel
...
// ZoneStubStubFromResourceSchemaAttributes contains the schema attributes for ZoneStubStubFromModel
...
// ExpandZoneStubStubFrom converts a Terraform Object to SDK type
func ExpandZoneStubStubFrom(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneStubStubFrom {
...
func (m *ZoneStubStubFromModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneStubStubFrom {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneStubStubFrom{
...
// FlattenZoneStubStubFrom converts an SDK type to Terraform Object
func FlattenZoneStubStubFrom(ctx context.Context, from *niosdns.ZoneStubStubFrom, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneStubStubFromModel) Flatten(ctx context.Context, from *niosdns.ZoneStubStubFrom, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
