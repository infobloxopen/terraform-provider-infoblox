...
var (
	_ list.ListResource                   = &ZoneDelegatedList{}
	_ list.ListResourceWithConfigure      = &ZoneDelegatedList{}
	_ list.ListResourceWithValidateConfig = &ZoneDelegatedList{}
)
...
func (l *ZoneDelegatedList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zone_delegated"
}

func (l *ZoneDelegatedList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewZoneDelegatedService(l.backend, client.NIOS, client.UDDI)
}

func (l *ZoneDelegatedList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox ZoneDelegated from both the NIOS and UDDI backends.",
...
func (l *ZoneDelegatedList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *ZoneDelegatedList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_zone_delegated list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.ZoneDelegated
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.ZoneDelegated, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.ZoneDelegated, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list ZoneDelegated records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
