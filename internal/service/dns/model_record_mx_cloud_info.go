...
// RecordMxCloudInfoModel is the Terraform model for RecordMxCloudInfo
...
// RecordMxCloudInfoAttrTypes contains the attribute types for RecordMxCloudInfoModel
...
// RecordMxCloudInfoResourceSchemaAttributes contains the schema attributes for RecordMxCloudInfoModel
...
// ExpandRecordMxCloudInfo converts a Terraform Object to SDK type
func ExpandRecordMxCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordMxCloudInfo {
...
func (m *RecordMxCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordMxCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordMxCloudInfo{
...
// FlattenRecordMxCloudInfo converts an SDK type to Terraform Object
func FlattenRecordMxCloudInfo(ctx context.Context, from *niosdns.RecordMxCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordMxCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordMxCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
