...
// RecordAliasCloudInfoModel is the Terraform model for RecordAliasCloudInfo
...
// RecordAliasCloudInfoAttrTypes contains the attribute types for RecordAliasCloudInfoModel
...
// RecordAliasCloudInfoResourceSchemaAttributes contains the schema attributes for RecordAliasCloudInfoModel
...
// ExpandRecordAliasCloudInfo converts a Terraform Object to SDK type
func ExpandRecordAliasCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordAliasCloudInfo {
...
func (m *RecordAliasCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordAliasCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordAliasCloudInfo{
...
// FlattenRecordAliasCloudInfo converts an SDK type to Terraform Object
func FlattenRecordAliasCloudInfo(ctx context.Context, from *niosdns.RecordAliasCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordAliasCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordAliasCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
