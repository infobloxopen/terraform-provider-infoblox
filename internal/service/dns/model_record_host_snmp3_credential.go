...
// RecordHostSnmp3CredentialModel is the Terraform model for RecordHostSnmp3Credential
...
// RecordHostSnmp3CredentialAttrTypes contains the attribute types for RecordHostSnmp3CredentialModel
...
// RecordHostSnmp3CredentialResourceSchemaAttributes contains the schema attributes for RecordHostSnmp3CredentialModel
...
// ExpandRecordHostSnmp3Credential converts a Terraform Object to SDK type
func ExpandRecordHostSnmp3Credential(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordHostSnmp3Credential {
...
func (m *RecordHostSnmp3CredentialModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordHostSnmp3Credential {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordHostSnmp3Credential{
...
// FlattenRecordHostSnmp3Credential converts an SDK type to Terraform Object
func FlattenRecordHostSnmp3Credential(ctx context.Context, from *niosdns.RecordHostSnmp3Credential, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordHostSnmp3CredentialModel) Flatten(ctx context.Context, from *niosdns.RecordHostSnmp3Credential, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
