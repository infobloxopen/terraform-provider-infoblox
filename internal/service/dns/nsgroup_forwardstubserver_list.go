...
var (
	_ list.ListResource                   = &NsgroupForwardstubserverList{}
	_ list.ListResourceWithConfigure      = &NsgroupForwardstubserverList{}
	_ list.ListResourceWithValidateConfig = &NsgroupForwardstubserverList{}
)
...
func (l *NsgroupForwardstubserverList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_nsgroup_forwardstubserver"
}

func (l *NsgroupForwardstubserverList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewNsgroupForwardstubserverService(l.backend, client.NIOS, client.UDDI)
}

func (l *NsgroupForwardstubserverList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox NsgroupForwardstubserver from the NIOS backend.",
...
func (l *NsgroupForwardstubserverList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *NsgroupForwardstubserverList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_nsgroup_forwardstubserver list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.NsgroupForwardstubserver
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.NsgroupForwardstubserver, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.NsgroupForwardstubserver, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list NsgroupForwardstubserver records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
