...
// RecordAaaaCloudInfoModel is the Terraform model for RecordAaaaCloudInfo
...
// RecordAaaaCloudInfoAttrTypes contains the attribute types for RecordAaaaCloudInfoModel
...
// RecordAaaaCloudInfoResourceSchemaAttributes contains the schema attributes for RecordAaaaCloudInfoModel
...
// ExpandRecordAaaaCloudInfo converts a Terraform Object to SDK type
func ExpandRecordAaaaCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordAaaaCloudInfo {
...
func (m *RecordAaaaCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordAaaaCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordAaaaCloudInfo{
...
// FlattenRecordAaaaCloudInfo converts an SDK type to Terraform Object
func FlattenRecordAaaaCloudInfo(ctx context.Context, from *niosdns.RecordAaaaCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordAaaaCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordAaaaCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
