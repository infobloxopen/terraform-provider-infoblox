...
// RecordSrvCloudInfoModel is the Terraform model for RecordSrvCloudInfo
...
// RecordSrvCloudInfoAttrTypes contains the attribute types for RecordSrvCloudInfoModel
...
// RecordSrvCloudInfoResourceSchemaAttributes contains the schema attributes for RecordSrvCloudInfoModel
...
// ExpandRecordSrvCloudInfo converts a Terraform Object to SDK type
func ExpandRecordSrvCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordSrvCloudInfo {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m RecordSrvCloudInfoModel
...
func (m *RecordSrvCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordSrvCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordSrvCloudInfo{
...
// FlattenRecordSrvCloudInfo converts an SDK type to Terraform Object
func FlattenRecordSrvCloudInfo(ctx context.Context, from *niosdns.RecordSrvCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordSrvCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordSrvCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
