...
var (
	_ list.ListResource                   = &SharedrecordgroupList{}
	_ list.ListResourceWithConfigure      = &SharedrecordgroupList{}
	_ list.ListResourceWithValidateConfig = &SharedrecordgroupList{}
)
...
func (l *SharedrecordgroupList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewSharedrecordgroupService(l.backend, client.NIOS, client.UDDI)
}

func (l *SharedrecordgroupList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Sharedrecordgroup from the NIOS backend.",
...
func (l *SharedrecordgroupList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *SharedrecordgroupList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	var records []*coremodel.Sharedrecordgroup
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Sharedrecordgroup, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Sharedrecordgroup, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Sharedrecordgroup records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
