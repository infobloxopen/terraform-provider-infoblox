...
var (
	_ list.ListResource                   = &ZoneRpList{}
	_ list.ListResourceWithConfigure      = &ZoneRpList{}
	_ list.ListResourceWithValidateConfig = &ZoneRpList{}
)
...
func (l *ZoneRpList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zone_rp"
}

func (l *ZoneRpList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewZoneRpService(l.backend, client.NIOS, client.UDDI)
}

func (l *ZoneRpList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox ZoneRp from the NIOS backend.",
...
func (l *ZoneRpList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *ZoneRpList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_zone_rp list: req.Limit=%d backend=%s includeResource=%t",
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.ZoneRp, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.ZoneRp, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list ZoneRp records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
