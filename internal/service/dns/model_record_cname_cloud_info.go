...
// RecordCnameCloudInfoModel is the Terraform model for RecordCnameCloudInfo
...
// RecordCnameCloudInfoAttrTypes contains the attribute types for RecordCnameCloudInfoModel
...
// RecordCnameCloudInfoResourceSchemaAttributes contains the schema attributes for RecordCnameCloudInfoModel
...
// ExpandRecordCnameCloudInfo converts a Terraform Object to SDK type
func ExpandRecordCnameCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordCnameCloudInfo {
...
func (m *RecordCnameCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordCnameCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordCnameCloudInfo{
...
// FlattenRecordCnameCloudInfo converts an SDK type to Terraform Object
func FlattenRecordCnameCloudInfo(ctx context.Context, from *niosdns.RecordCnameCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordCnameCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordCnameCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
