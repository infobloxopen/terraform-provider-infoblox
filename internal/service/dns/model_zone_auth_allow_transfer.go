...
// ZoneAuthAllowTransferModel is the Terraform model for ZoneAuthAllowTransfer
...
// ZoneAuthAllowTransferAttrTypes contains the attribute types for ZoneAuthAllowTransferModel
...
// ZoneAuthAllowTransferResourceSchemaAttributes contains the schema attributes for ZoneAuthAllowTransferModel
...
// ExpandZoneAuthAllowTransfer converts a Terraform Object to SDK type
func ExpandZoneAuthAllowTransfer(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneAuthAllowTransfer {
...
func (m *ZoneAuthAllowTransferModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneAuthAllowTransfer {
	if m == nil {
		return nil
	}
...
// FlattenZoneAuthAllowTransfer converts an SDK type to Terraform Object
func FlattenZoneAuthAllowTransfer(ctx context.Context, from *niosdns.ZoneAuthAllowTransfer, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneAuthAllowTransferModel) Flatten(ctx context.Context, from *niosdns.ZoneAuthAllowTransfer, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
