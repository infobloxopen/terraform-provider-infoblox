...
// ExpandNsgroupExternalPrimaries converts a Terraform Object to SDK type
func ExpandNsgroupExternalPrimaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.NsgroupExternalPrimaries {
...
func (m *NsgroupExternalPrimariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.NsgroupExternalPrimaries {
	if m == nil {
		return nil
	}
...
// FlattenNsgroupExternalPrimaries converts an SDK type to Terraform Object
func FlattenNsgroupExternalPrimaries(ctx context.Context, from *niosdns.NsgroupExternalPrimaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NsgroupExternalPrimariesModel) Flatten(ctx context.Context, from *niosdns.NsgroupExternalPrimaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
