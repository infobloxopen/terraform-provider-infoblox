...
// ZonestubstubmembersPreferredPrimariesModel is the Terraform model for ZonestubstubmembersPreferredPrimaries
...
// ZonestubstubmembersPreferredPrimariesAttrTypes contains the attribute types for ZonestubstubmembersPreferredPrimariesModel
...
// ZonestubstubmembersPreferredPrimariesResourceSchemaAttributes contains the schema attributes for ZonestubstubmembersPreferredPrimariesModel
...
// ExpandZonestubstubmembersPreferredPrimaries converts a Terraform Object to SDK type
func ExpandZonestubstubmembersPreferredPrimaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZonestubstubmembersPreferredPrimaries {
...
func (m *ZonestubstubmembersPreferredPrimariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZonestubstubmembersPreferredPrimaries {
	if m == nil {
		return nil
	}
	to := &niosdns.ZonestubstubmembersPreferredPrimaries{
...
// FlattenZonestubstubmembersPreferredPrimaries converts an SDK type to Terraform Object
func FlattenZonestubstubmembersPreferredPrimaries(ctx context.Context, from *niosdns.ZonestubstubmembersPreferredPrimaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZonestubstubmembersPreferredPrimariesModel) Flatten(ctx context.Context, from *niosdns.ZonestubstubmembersPreferredPrimaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
