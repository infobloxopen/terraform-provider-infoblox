...
var (
	_ list.ListResource                   = &SharedrecordMxList{}
	_ list.ListResourceWithConfigure      = &SharedrecordMxList{}
	_ list.ListResourceWithValidateConfig = &SharedrecordMxList{}
)
...
func (l *SharedrecordMxList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sharedrecord_mx"
}

func (l *SharedrecordMxList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewSharedrecordMxService(l.backend, client.NIOS, client.UDDI)
}

func (l *SharedrecordMxList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox SharedrecordMx from the NIOS backend.",
...
func (l *SharedrecordMxList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *SharedrecordMxList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_sharedrecord_mx list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.SharedrecordMx
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.SharedrecordMx, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.SharedrecordMx, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list SharedrecordMx records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
