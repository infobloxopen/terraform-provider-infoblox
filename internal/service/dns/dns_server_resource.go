...
var (
	...
	_ resource.ResourceWithValidateConfig = &DnsServerResource{}
	_ resource.ResourceWithConfigure      = &DnsServerResource{}
	_ resource.ResourceWithImportState    = &DnsServerResource{}
	_ resource.ResourceWithIdentity       = &DnsServerResource{}
)
...
func (r *DnsServerResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *DnsServerResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox DnsServer in the UDDI backend.",
		Attributes:          DnsServerResourceSchemaAttributes,
	}
}
...
func (r *DnsServerResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewDnsServerService(r.backend, client.NIOS, client.UDDI)
}

func (r *DnsServerResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.DnsServer](r.backend, op)
}

func (r *DnsServerResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateDnsServer(ctx, data, resp)
}
...
func (r *DnsServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err := retry.Do(ctx, r.retryPolicy(retry.OpCreate), func(ctx context.Context) (int, error) {
		...
		apiResp, httpResp, apiErr = r.service.Create(ctx, obj, &core.Options{
			...
			Inherit:      DnsServerInheritanceType,
		})
		if httpResp != nil {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create DnsServer: %s", err))
		return
	}
...
func (r *DnsServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read DnsServer: %s", err))
		return
	}
...
func (r *DnsServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update DnsServer: %s", err))
		return
	}
...
func (r *DnsServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete DnsServer: %s", err))
	}
}
