...
// ViewMatchClientsModel is the Terraform model for ViewMatchClients
...
// ViewMatchClientsAttrTypes contains the attribute types for ViewMatchClientsModel
...
// ExpandViewMatchClients converts a Terraform Object to SDK type
func ExpandViewMatchClients(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ViewMatchClients {
...
func (m *ViewMatchClientsModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ViewMatchClients {
	if m == nil {
		return nil
	}
	to := &niosdns.ViewMatchClients{
...
// FlattenViewMatchClients converts an SDK type to Terraform Object
func FlattenViewMatchClients(ctx context.Context, from *niosdns.ViewMatchClients, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ViewMatchClientsModel) Flatten(ctx context.Context, from *niosdns.ViewMatchClients, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
