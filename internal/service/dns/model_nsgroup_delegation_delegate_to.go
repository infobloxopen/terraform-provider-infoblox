...
// ExpandNsgroupDelegationDelegateTo converts a Terraform Object to SDK type
func ExpandNsgroupDelegationDelegateTo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.NsgroupDelegationDelegateTo {
...
func (m *NsgroupDelegationDelegateToModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.NsgroupDelegationDelegateTo {
	if m == nil {
		return nil
	}
...
// FlattenNsgroupDelegationDelegateTo converts an SDK type to Terraform Object
func FlattenNsgroupDelegationDelegateTo(ctx context.Context, from *niosdns.NsgroupDelegationDelegateTo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NsgroupDelegationDelegateToModel) Flatten(ctx context.Context, from *niosdns.NsgroupDelegationDelegateTo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
