...
var (
	_ list.ListResource                   = &ZoneStubList{}
	_ list.ListResourceWithConfigure      = &ZoneStubList{}
	_ list.ListResourceWithValidateConfig = &ZoneStubList{}
)

func NewZoneStubList() list.ListResource {
	return &ZoneStubList{}
}

type ZoneStubList struct {
	backend core.BackendType
	service coresvc.ZoneStubService
}

type ZoneStubListModel struct {
	Filters        types.Map `tfsdk:"filters"`
	ExtAttrFilters types.Map `tfsdk:"ext_attr_filters"`
}

func (l *ZoneStubList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zone_stub"
}

func (l *ZoneStubList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewZoneStubService(l.backend, client.NIOS, client.UDDI)
}

func (l *ZoneStubList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox ZoneStub from the NIOS backend.",
...
func (l *ZoneStubList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data ZoneStubListModel
...
func (l *ZoneStubList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data ZoneStubListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_zone_stub list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.ZoneStub
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.ZoneStub, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.ZoneStub, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list ZoneStub records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
