...
// ZoneForwardForwardToModel is the Terraform model for ZoneForwardForwardTo
...
// ZoneForwardForwardToAttrTypes contains the attribute types for ZoneForwardForwardToModel
...
// ZoneForwardForwardToResourceSchemaAttributes contains the schema attributes for ZoneForwardForwardToModel
...
// ExpandZoneForwardForwardTo converts a Terraform Object to SDK type
func ExpandZoneForwardForwardTo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneForwardForwardTo {
...
func (m *ZoneForwardForwardToModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneForwardForwardTo {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneForwardForwardTo{
...
// FlattenZoneForwardForwardTo converts an SDK type to Terraform Object
func FlattenZoneForwardForwardTo(ctx context.Context, from *niosdns.ZoneForwardForwardTo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneForwardForwardToModel) Flatten(ctx context.Context, from *niosdns.ZoneForwardForwardTo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
