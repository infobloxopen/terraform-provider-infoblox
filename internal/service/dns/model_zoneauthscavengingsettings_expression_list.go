...
// ZoneauthscavengingsettingsExpressionListModel is the Terraform model for ZoneauthscavengingsettingsExpressionList
...
// ZoneauthscavengingsettingsExpressionListAttrTypes contains the attribute types for ZoneauthscavengingsettingsExpressionListModel
...
// ZoneauthscavengingsettingsExpressionListResourceSchemaAttributes contains the schema attributes for ZoneauthscavengingsettingsExpressionListModel
...
// ExpandZoneauthscavengingsettingsExpressionList converts a Terraform Object to SDK type
func ExpandZoneauthscavengingsettingsExpressionList(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneauthscavengingsettingsExpressionList {
...
func (m *ZoneauthscavengingsettingsExpressionListModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneauthscavengingsettingsExpressionList {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneauthscavengingsettingsExpressionList{
...
// FlattenZoneauthscavengingsettingsExpressionList converts an SDK type to Terraform Object
func FlattenZoneauthscavengingsettingsExpressionList(ctx context.Context, from *niosdns.ZoneauthscavengingsettingsExpressionList, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneauthscavengingsettingsExpressionListModel) Flatten(ctx context.Context, from *niosdns.ZoneauthscavengingsettingsExpressionList, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
