...
// ZoneauthgridsecondariesPreferredPrimariesModel is the Terraform model for ZoneauthgridsecondariesPreferredPrimaries
...
// ZoneauthgridsecondariesPreferredPrimariesAttrTypes contains the attribute types for ZoneauthgridsecondariesPreferredPrimariesModel
...
// ZoneauthgridsecondariesPreferredPrimariesResourceSchemaAttributes contains the schema attributes for ZoneauthgridsecondariesPreferredPrimariesModel
...
// ExpandZoneauthgridsecondariesPreferredPrimaries converts a Terraform Object to SDK type
func ExpandZoneauthgridsecondariesPreferredPrimaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneauthgridsecondariesPreferredPrimaries {
...
func (m *ZoneauthgridsecondariesPreferredPrimariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneauthgridsecondariesPreferredPrimaries {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneauthgridsecondariesPreferredPrimaries{
...
// FlattenZoneauthgridsecondariesPreferredPrimaries converts an SDK type to Terraform Object
func FlattenZoneauthgridsecondariesPreferredPrimaries(ctx context.Context, from *niosdns.ZoneauthgridsecondariesPreferredPrimaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneauthgridsecondariesPreferredPrimariesModel) Flatten(ctx context.Context, from *niosdns.ZoneauthgridsecondariesPreferredPrimaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
