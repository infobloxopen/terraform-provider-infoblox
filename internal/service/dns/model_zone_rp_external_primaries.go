...
// ZoneRpExternalPrimariesModel is the Terraform model for ZoneRpExternalPrimaries
...
// ZoneRpExternalPrimariesAttrTypes contains the attribute types for ZoneRpExternalPrimariesModel
...
// ZoneRpExternalPrimariesResourceSchemaAttributes contains the schema attributes for ZoneRpExternalPrimariesModel
...
// ExpandZoneRpExternalPrimaries converts a Terraform Object to SDK type
func ExpandZoneRpExternalPrimaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.ZoneRpExternalPrimaries {
...
func (m *ZoneRpExternalPrimariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.ZoneRpExternalPrimaries {
	if m == nil {
		return nil
	}
	to := &niosdns.ZoneRpExternalPrimaries{
...
// FlattenZoneRpExternalPrimaries converts an SDK type to Terraform Object
func FlattenZoneRpExternalPrimaries(ctx context.Context, from *niosdns.ZoneRpExternalPrimaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ZoneRpExternalPrimariesModel) Flatten(ctx context.Context, from *niosdns.ZoneRpExternalPrimaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
