...
var (
	_ list.ListResource                   = &DnsServerList{}
	_ list.ListResourceWithConfigure      = &DnsServerList{}
	_ list.ListResourceWithValidateConfig = &DnsServerList{}
)

func NewDnsServerList() list.ListResource {
...
type DnsServerListModel struct {
	Filters    types.Map `tfsdk:"filters"`
	TagFilters types.Map `tfsdk:"tag_filters"`
}

func (l *DnsServerList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dns_server"
}

func (l *DnsServerList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewDnsServerService(l.backend, client.NIOS, client.UDDI)
}

func (l *DnsServerList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox DnsServer from the UDDI backend.",
...
func (l *DnsServerList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data DnsServerListModel
...
func (l *DnsServerList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data DnsServerListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_dns_server list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.DnsServer
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.DnsServer, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.DnsServer, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list DnsServer records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
