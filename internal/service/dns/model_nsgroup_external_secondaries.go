...
// NsgroupExternalSecondariesModel is the Terraform model for NsgroupExternalSecondaries
...
// NsgroupExternalSecondariesAttrTypes contains the attribute types for NsgroupExternalSecondariesModel
...
// NsgroupExternalSecondariesResourceSchemaAttributes contains the schema attributes for NsgroupExternalSecondariesModel
...
// ExpandNsgroupExternalSecondaries converts a Terraform Object to SDK type
func ExpandNsgroupExternalSecondaries(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.NsgroupExternalSecondaries {
...
func (m *NsgroupExternalSecondariesModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.NsgroupExternalSecondaries {
	if m == nil {
		return nil
	}
	to := &niosdns.NsgroupExternalSecondaries{
...
// FlattenNsgroupExternalSecondaries converts an SDK type to Terraform Object
func FlattenNsgroupExternalSecondaries(ctx context.Context, from *niosdns.NsgroupExternalSecondaries, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NsgroupExternalSecondariesModel) Flatten(ctx context.Context, from *niosdns.NsgroupExternalSecondaries, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
