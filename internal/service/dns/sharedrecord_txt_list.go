...
var (
	_ list.ListResource                   = &SharedrecordTxtList{}
	_ list.ListResourceWithConfigure      = &SharedrecordTxtList{}
	_ list.ListResourceWithValidateConfig = &SharedrecordTxtList{}
)
...
func (l *SharedrecordTxtList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sharedrecord_txt"
}

func (l *SharedrecordTxtList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewSharedrecordTxtService(l.backend, client.NIOS, client.UDDI)
}

func (l *SharedrecordTxtList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox SharedrecordTxt from the NIOS backend.",
...
func (l *SharedrecordTxtList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *SharedrecordTxtList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_sharedrecord_txt list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.SharedrecordTxt
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.SharedrecordTxt, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.SharedrecordTxt, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list SharedrecordTxt records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
