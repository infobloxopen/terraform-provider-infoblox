...
var (
	_ list.ListResource                   = &SharedrecordAaaaList{}
	_ list.ListResourceWithConfigure      = &SharedrecordAaaaList{}
	_ list.ListResourceWithValidateConfig = &SharedrecordAaaaList{}
)
...
func (l *SharedrecordAaaaList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sharedrecord_aaaa"
}

func (l *SharedrecordAaaaList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewSharedrecordAaaaService(l.backend, client.NIOS, client.UDDI)
}

func (l *SharedrecordAaaaList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox SharedrecordAaaa from the NIOS backend.",
...
func (l *SharedrecordAaaaList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
...
func (l *SharedrecordAaaaList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_sharedrecord_aaaa list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.SharedrecordAaaa
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.SharedrecordAaaa, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.SharedrecordAaaa, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list SharedrecordAaaa records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
