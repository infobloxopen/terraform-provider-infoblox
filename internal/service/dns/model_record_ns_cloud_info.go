...
// RecordNsCloudInfoModel is the Terraform model for RecordNsCloudInfo
...
// RecordNsCloudInfoAttrTypes contains the attribute types for RecordNsCloudInfoModel
...
// RecordNsCloudInfoResourceSchemaAttributes contains the schema attributes for RecordNsCloudInfoModel
...
// ExpandRecordNsCloudInfo converts a Terraform Object to SDK type
func ExpandRecordNsCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordNsCloudInfo {
...
func (m *RecordNsCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordNsCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordNsCloudInfo{
...
// FlattenRecordNsCloudInfo converts an SDK type to Terraform Object
func FlattenRecordNsCloudInfo(ctx context.Context, from *niosdns.RecordNsCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordNsCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordNsCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
