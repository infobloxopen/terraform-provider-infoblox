# Auto-generated resource acceptance-test cases for Fixedaddress.
case "basic" {
  backend  = "uddi"
  parallel = true
...
case "address" {
  ...
  // Create an Fixed Address using a Next Available Feature in a Subnet
  step {
    uddi {
...
case "ip_space" {
  ...
  resource "infoblox_network" "test2" {
      uddi = {
        address = "10.0.0.0"
        cidr = 24
...
case "next_available_id_count" {
  ...
  resource "infoblox_fixed_address" "bulk" {
      count = 5
      uddi = {
        ip_space              = infoblox_network_view.test.id
        dynamic_allocation = { next_available_id = infoblox_network.test.id }
      ...
      depends_on = [infoblox_network.test , infoblox_network_view.test ]
 }
  ...
  step {
    uddi {
      ...
      ip_space             = infoblox_network_view.test.id
      match_type        = "mac"
      match_value       = "aa:aa:aa:aa:ab:ae"
    }
    depends_on = [infoblox_fixed_address.bulk]
    check = {
