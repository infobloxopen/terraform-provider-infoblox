...
case "comment" {
  ...
  step {
    nios {
      ...
      canonical = "{{random2}}.${infoblox_zone_rp.test.nios.fqdn}"
      rp_zone   = infoblox_zone_rp.test.nios.fqdn
      comment   = "This is a new rpz cname ipaddress dn record"
    }
    check = {
      "nios.comment" = "This is a new rpz cname ipaddress dn record"
    }
  }
  ...
  step {
    nios {
      ...
      canonical = "{{random2}}.${infoblox_zone_rp.test.nios.fqdn}"
      rp_zone   = infoblox_zone_rp.test.nios.fqdn
      comment   = "This is an updated rpz cname ipaddress dn record"
    }
    check = {
      "nios.comment" = "This is an updated rpz cname ipaddress dn record"
    }
  }
