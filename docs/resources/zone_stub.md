...
page_title: "infoblox_zone_stub Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Manages an Infoblox ZoneStub in the NIOS backend.
---

# infoblox_zone_stub (Resource)
...
- `stub_from` (Attributes List) The primary servers (masters) of this stub zone. (see [below for nested schema](#nestedatt--nios--stub_from))
...
- `stub_msservers` (Attributes List) The Microsoft DNS servers of this stub zone. Note that the stealth field of the struct will be ignored when set in this field. (see [below for nested schema](#nestedatt--nios--stub_msservers))
...
<a id="nestedatt--nios--stub_from"></a>
### Nested Schema for `nios.stub_from`
...
- `preferred_primaries` (Attributes List) The primary preference list with Grid member names and\or External Server extserver structs for this member. (see [below for nested schema](#nestedatt--nios--stub_members--preferred_primaries))
...
<a id="nestedatt--nios--stub_members--preferred_primaries"></a>
### Nested Schema for `nios.stub_members.preferred_primaries`
...
<a id="nestedatt--nios--stub_msservers"></a>
### Nested Schema for `nios.stub_msservers`
