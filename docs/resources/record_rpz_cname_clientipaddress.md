...
page_title: "infoblox_record_rpz_cname_clientipaddress Resource - terraform-provider-infoblox"
subcategory: "RPZ"
description: |-
  Manages an Infoblox RecordRpzCnameClientipaddress in the NIOS backend.
---

# infoblox_record_rpz_cname_clientipaddress (Resource)
