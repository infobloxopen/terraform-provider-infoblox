...
page_title: "unified_dns_record_a Resource - terraform-provider-unified"
subcategory: "DNS"
description: |-
  Manages a unified DNS RecordA record across NIOS and UDDI backends.
---

# unified_dns_record_a (Resource)
