...
page_title: "infoblox_record_rpz_cname_ipaddressdn Resource - terraform-provider-infoblox"
subcategory: "RPZ"
description: |-
  Manages an Infoblox RecordRpzCnameIpaddressdn in the NIOS backend.
---

# infoblox_record_rpz_cname_ipaddressdn (Resource)
