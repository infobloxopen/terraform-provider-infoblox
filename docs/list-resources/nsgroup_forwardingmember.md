...
page_title: "infoblox_nsgroup_forwardingmember List Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves a list of Infoblox NsgroupForwardingmember from the NIOS backend.
---

# infoblox_nsgroup_forwardingmember (List Resource)
