...
page_title: "infoblox_record_aaaa List Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves a list of Infoblox RecordAaaa from the configured backend (NIOS or UDDI).
---

# infoblox_record_aaaa (List Resource)
