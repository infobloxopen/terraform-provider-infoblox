...
page_title: "infoblox_dtc_pool List Resource - terraform-provider-infoblox"
subcategory: "DTC"
description: |-
  Retrieves a list of Infoblox DtcPool from both the NIOS and UDDI backends.
---

# infoblox_dtc_pool (List Resource)
