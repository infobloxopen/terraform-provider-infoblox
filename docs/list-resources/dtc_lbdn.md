...
page_title: "infoblox_dtc_lbdn List Resource - terraform-provider-infoblox"
subcategory: "DTC"
description: |-
  Retrieves a list of Infoblox DtcLbdn from both the NIOS and UDDI backends.
---

# infoblox_dtc_lbdn (List Resource)
