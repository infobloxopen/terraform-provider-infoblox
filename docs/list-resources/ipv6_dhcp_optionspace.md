...
page_title: "infoblox_ipv6_dhcp_optionspace List Resource - terraform-provider-infoblox"
subcategory: "DHCP"
description: |-
  Retrieves a list of Infoblox Ipv6DhcpOptionspace from both the NIOS and UDDI backends.
---

# infoblox_ipv6_dhcp_optionspace (List Resource)
