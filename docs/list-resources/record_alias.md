...
page_title: "infoblox_record_alias List Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves a list of Infoblox RecordAlias from the NIOS backend.
---

# infoblox_record_alias (List Resource)
