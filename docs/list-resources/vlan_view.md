...
page_title: "infoblox_vlan_view List Resource - terraform-provider-infoblox"
subcategory: "IPAM"
description: |-
  Retrieves a list of Infoblox Vlanview from the NIOS backend.
---

# infoblox_vlan_view (List Resource)
