...
page_title: "infoblox_dtc_monitor_icmp List Resource - terraform-provider-infoblox"
subcategory: "DTC"
description: |-
  Retrieves a list of Infoblox DtcMonitorIcmp from both the NIOS and UDDI backends.
---

# infoblox_dtc_monitor_icmp (List Resource)
