...
page_title: "infoblox_record_srv List Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves a list of Infoblox RecordSrv from the configured backend (NIOS or UDDI).
---

# infoblox_record_srv (List Resource)
