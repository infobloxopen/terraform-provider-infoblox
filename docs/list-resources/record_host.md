...
page_title: "infoblox_record_host List Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves a list of Infoblox RecordHost from the NIOS backend.
---

# infoblox_record_host (List Resource)
