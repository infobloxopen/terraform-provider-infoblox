...
page_title: "infoblox_fixed_address List Resource - terraform-provider-infoblox"
subcategory: "DHCP"
description: |-
  Retrieves a list of Infoblox Fixedaddress from both the NIOS and UDDI backends.
---

# infoblox_fixed_address (List Resource)
