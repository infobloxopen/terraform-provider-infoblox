...
page_title: "infoblox_vlan_range List Resource - terraform-provider-infoblox"
subcategory: "IPAM"
description: |-
  Retrieves a list of Infoblox Vlanrange from the NIOS backend.
---

# infoblox_vlan_range (List Resource)
