...
page_title: "infoblox_record_rpz_a_ipaddress List Resource - terraform-provider-infoblox"
subcategory: "RPZ"
description: |-
  Retrieves a list of Infoblox RecordRpzAIpaddress from the NIOS backend.
---

# infoblox_record_rpz_a_ipaddress (List Resource)
