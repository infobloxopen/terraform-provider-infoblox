...
page_title: "infoblox_record_cname List Resource - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves a list of Infoblox RecordCname from the configured backend (NIOS or UDDI).
---

# infoblox_record_cname (List Resource)
