...
page_title: "infoblox_notification_rest_endpoint List Resource - terraform-provider-infoblox"
subcategory: "NOTIFICATION"
description: |-
  Retrieves a list of Infoblox NotificationRestEndpoint from the NIOS backend.
---

# infoblox_notification_rest_endpoint (List Resource)
