...
page_title: "infoblox_record_host Data Source - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves information about existing Infoblox RecordHost from the NIOS backend.
---

# infoblox_record_host (Data Source)
...
- `cli_credentials` (Attributes List) The CLI credentials for the host record. (see [below for nested schema](#nestedatt--results--nios--cli_credentials))
...
- `ipv4addrs` (Attributes List) This is a list of IPv4 Addresses for the host. (see [below for nested schema](#nestedatt--results--nios--ipv4addrs))
- `ipv6addrs` (Attributes List) This is a list of IPv6 Addresses for the host. (see [below for nested schema](#nestedatt--results--nios--ipv6addrs))
...
<a id="nestedatt--results--nios--ipv4addrs"></a>
### Nested Schema for `results.nios.ipv4addrs`
...
- `discovered_data` (Attributes) (see [below for nested schema](#nestedatt--results--nios--ipv4addrs--discovered_data))
- `dynamic_allocation` (Attributes) Dynamically allocate the ip using the NIOS next_available_ip function call. Mutually exclusive with the static value field. (see [below for nested schema](#nestedatt--results--nios--ipv4addrs--dynamic_allocation))
...
- `logic_filter_rules` (Attributes List) This field contains the logic filters to be applied on the this host address. This list corresponds to the match rules that are written to the dhcpd configuration file. (see [below for nested schema](#nestedatt--results--nios--ipv4addrs--logic_filter_rules))
...
- `ms_ad_user_data` (Attributes) (see [below for nested schema](#nestedatt--results--nios--ipv4addrs--ms_ad_user_data))
...
- `options` (Attributes List) An array of DHCP option dhcpoption structs that lists the DHCP options associated with the object. (see [below for nested schema](#nestedatt--results--nios--ipv4addrs--options))
...
<a id="nestedatt--results--nios--ipv4addrs--discovered_data"></a>
### Nested Schema for `results.nios.ipv4addrs.discovered_data`
...
<a id="nestedatt--results--nios--ipv4addrs--dynamic_allocation"></a>
### Nested Schema for `results.nios.ipv4addrs.dynamic_allocation`
...
<a id="nestedatt--results--nios--ipv4addrs--logic_filter_rules"></a>
### Nested Schema for `results.nios.ipv4addrs.logic_filter_rules`
...
<a id="nestedatt--results--nios--ipv4addrs--ms_ad_user_data"></a>
### Nested Schema for `results.nios.ipv4addrs.ms_ad_user_data`
...
<a id="nestedatt--results--nios--ipv4addrs--options"></a>
### Nested Schema for `results.nios.ipv4addrs.options`
...
<a id="nestedatt--results--nios--ipv6addrs"></a>
### Nested Schema for `results.nios.ipv6addrs`
...
- `discovered_data` (Attributes) (see [below for nested schema](#nestedatt--results--nios--ipv6addrs--discovered_data))
...
- `dynamic_allocation` (Attributes) Dynamically allocate the ip using the NIOS next_available_ip function call. Mutually exclusive with the static value field. (see [below for nested schema](#nestedatt--results--nios--ipv6addrs--dynamic_allocation))
...
- `last_queried` (Number) The time of the last DNS query in Epoch seconds format.
- `logic_filter_rules` (Attributes List) This field contains the logic filters to be applied on the this host address. This list corresponds to the match rules that are written to the dhcpd configuration file. (see [below for nested schema](#nestedatt--results--nios--ipv6addrs--logic_filter_rules))
- `mac` (String) The MAC address for this host address.
...
- `ms_ad_user_data` (Attributes) (see [below for nested schema](#nestedatt--results--nios--ipv6addrs--ms_ad_user_data))
- `network` (String) The network of the host address, in FQDN/CIDR format.
- `network_view` (String) The name of the network view in which the host address resides.
- `options` (Attributes List) An array of DHCP option dhcpoption structs that lists the DHCP options associated with the object. (see [below for nested schema](#nestedatt--results--nios--ipv6addrs--options))
...
<a id="nestedatt--results--nios--ipv6addrs--discovered_data"></a>
### Nested Schema for `results.nios.ipv6addrs.discovered_data`
...
<a id="nestedatt--results--nios--ipv6addrs--dynamic_allocation"></a>
### Nested Schema for `results.nios.ipv6addrs.dynamic_allocation`
...
<a id="nestedatt--results--nios--ipv6addrs--logic_filter_rules"></a>
### Nested Schema for `results.nios.ipv6addrs.logic_filter_rules`
...
<a id="nestedatt--results--nios--ipv6addrs--ms_ad_user_data"></a>
### Nested Schema for `results.nios.ipv6addrs.ms_ad_user_data`
...
<a id="nestedatt--results--nios--ipv6addrs--options"></a>
### Nested Schema for `results.nios.ipv6addrs.options`
