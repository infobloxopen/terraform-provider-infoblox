...
page_title: "infoblox_sharedrecord_aaaa Data Source - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves information about existing Infoblox SharedrecordAaaa from the NIOS backend.
---

# infoblox_sharedrecord_aaaa (Data Source)
