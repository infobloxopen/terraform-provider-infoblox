...
page_title: "infoblox_record_rpz_cname Data Source - terraform-provider-infoblox"
subcategory: "RPZ"
description: |-
  Retrieves information about existing Infoblox RecordRpzCname from the NIOS backend.
---

# infoblox_record_rpz_cname (Data Source)
