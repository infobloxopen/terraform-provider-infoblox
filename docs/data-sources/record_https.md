...
page_title: "infoblox_record_https Data Source - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves information about existing Infoblox RecordHttps from the UDDI backend.
---

# infoblox_record_https (Data Source)
