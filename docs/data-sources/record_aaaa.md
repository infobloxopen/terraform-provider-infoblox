...
page_title: "infoblox_record_aaaa Data Source - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves information about existing Infoblox RecordAaaa across NIOS and UDDI backends.
---

# infoblox_record_aaaa (Data Source)
...
- `rdata` (Attributes) The DNS resource record data in JSON format. Certain DNS resource record-specific subfields are required for creating the DNS resource record.  Subfields for _AAAA_ (IPv6 Address) record:  Subfield | Description                           | Required ---------|---------------------------------------|--------- address  | The IPv6 address of the host.<br><br> | Yes (see [below for nested schema](#nestedatt--results--uddi--rdata))
