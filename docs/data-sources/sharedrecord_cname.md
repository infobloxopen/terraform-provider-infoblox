...
page_title: "infoblox_sharedrecord_cname Data Source - terraform-provider-infoblox"
subcategory: "DNS"
description: |-
  Retrieves information about existing Infoblox SharedrecordCname from the NIOS backend.
---

# infoblox_sharedrecord_cname (Data Source)
