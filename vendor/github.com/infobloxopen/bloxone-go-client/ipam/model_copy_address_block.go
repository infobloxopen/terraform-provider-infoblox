...
// checks if the CopyAddressBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyAddressBlock{}

// CopyAddressBlock struct for CopyAddressBlock
type CopyAddressBlock struct {
...
type _CopyAddressBlock CopyAddressBlock
...
func (o CopyAddressBlock) MarshalJSON() ([]byte, error) {
...
func (o CopyAddressBlock) ToMap() (map[string]interface{}, error) {
...
func (o *CopyAddressBlock) UnmarshalJSON(data []byte) (err error) {
	...
	varCopyAddressBlock := _CopyAddressBlock{}

	err = json.Unmarshal(data, &varCopyAddressBlock)

	if err != nil {
		return err
	}

	*o = CopyAddressBlock(varCopyAddressBlock)
...
type NullableCopyAddressBlock struct {
	value *CopyAddressBlock
	isSet bool
}

func (v NullableCopyAddressBlock) Get() *CopyAddressBlock {
	return v.value
}

func (v *NullableCopyAddressBlock) Set(val *CopyAddressBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyAddressBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyAddressBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyAddressBlock(val *CopyAddressBlock) *NullableCopyAddressBlock {
	return &NullableCopyAddressBlock{value: val, isSet: true}
}

func (v NullableCopyAddressBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyAddressBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
