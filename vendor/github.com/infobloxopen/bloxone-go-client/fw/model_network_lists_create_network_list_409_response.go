...
// checks if the NetworkListsCreateNetworkList409Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkListsCreateNetworkList409Response{}
...
type _NetworkListsCreateNetworkList409Response NetworkListsCreateNetworkList409Response
...
func NewNetworkListsCreateNetworkList409Response() *NetworkListsCreateNetworkList409Response {
	this := NetworkListsCreateNetworkList409Response{}
	return &this
}
...
func (o *NetworkListsCreateNetworkList409Response) GetError() NetworkListsCreateNetworkList409ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret NetworkListsCreateNetworkList409ResponseError
		return ret
	}
	return *o.Error
}
...
func (o *NetworkListsCreateNetworkList409Response) UnmarshalJSON(data []byte) (err error) {
	varNetworkListsCreateNetworkList409Response := _NetworkListsCreateNetworkList409Response{}

	err = json.Unmarshal(data, &varNetworkListsCreateNetworkList409Response)

	if err != nil {
		return err
	}

	*o = NetworkListsCreateNetworkList409Response(varNetworkListsCreateNetworkList409Response)
...
type NullableNetworkListsCreateNetworkList409Response struct {
	value *NetworkListsCreateNetworkList409Response
	isSet bool
}
...
func NewNullableNetworkListsCreateNetworkList409Response(val *NetworkListsCreateNetworkList409Response) *NullableNetworkListsCreateNetworkList409Response {
	return &NullableNetworkListsCreateNetworkList409Response{value: val, isSet: true}
}
