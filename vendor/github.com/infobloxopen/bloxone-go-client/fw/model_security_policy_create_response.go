...
// checks if the SecurityPolicyCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPolicyCreateResponse{}
...
type _SecurityPolicyCreateResponse SecurityPolicyCreateResponse
...
func NewSecurityPolicyCreateResponse() *SecurityPolicyCreateResponse {
	this := SecurityPolicyCreateResponse{}
	return &this
}
...
func (o *SecurityPolicyCreateResponse) UnmarshalJSON(data []byte) (err error) {
	varSecurityPolicyCreateResponse := _SecurityPolicyCreateResponse{}
	...
	*o = SecurityPolicyCreateResponse(varSecurityPolicyCreateResponse)
...
type NullableSecurityPolicyCreateResponse struct {
	value *SecurityPolicyCreateResponse
	isSet bool
}
...
func NewNullableSecurityPolicyCreateResponse(val *SecurityPolicyCreateResponse) *NullableSecurityPolicyCreateResponse {
	return &NullableSecurityPolicyCreateResponse{value: val, isSet: true}
}
