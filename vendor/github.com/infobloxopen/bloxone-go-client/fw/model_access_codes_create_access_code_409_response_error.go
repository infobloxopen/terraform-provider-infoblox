...
// checks if the AccessCodesCreateAccessCode409ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessCodesCreateAccessCode409ResponseError{}
...
type _AccessCodesCreateAccessCode409ResponseError AccessCodesCreateAccessCode409ResponseError
...
func NewAccessCodesCreateAccessCode409ResponseError() *AccessCodesCreateAccessCode409ResponseError {
	this := AccessCodesCreateAccessCode409ResponseError{}
	return &this
}
...
func (o *AccessCodesCreateAccessCode409ResponseError) UnmarshalJSON(data []byte) (err error) {
	varAccessCodesCreateAccessCode409ResponseError := _AccessCodesCreateAccessCode409ResponseError{}

	err = json.Unmarshal(data, &varAccessCodesCreateAccessCode409ResponseError)

	if err != nil {
		return err
	}

	*o = AccessCodesCreateAccessCode409ResponseError(varAccessCodesCreateAccessCode409ResponseError)
...
type NullableAccessCodesCreateAccessCode409ResponseError struct {
	value *AccessCodesCreateAccessCode409ResponseError
	isSet bool
}
...
func NewNullableAccessCodesCreateAccessCode409ResponseError(val *AccessCodesCreateAccessCode409ResponseError) *NullableAccessCodesCreateAccessCode409ResponseError {
	return &NullableAccessCodesCreateAccessCode409ResponseError{value: val, isSet: true}
}
