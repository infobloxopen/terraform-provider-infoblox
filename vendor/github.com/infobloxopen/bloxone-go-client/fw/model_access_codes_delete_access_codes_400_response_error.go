...
// checks if the AccessCodesDeleteAccessCodes400ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessCodesDeleteAccessCodes400ResponseError{}
...
type _AccessCodesDeleteAccessCodes400ResponseError AccessCodesDeleteAccessCodes400ResponseError
...
func NewAccessCodesDeleteAccessCodes400ResponseError() *AccessCodesDeleteAccessCodes400ResponseError {
	this := AccessCodesDeleteAccessCodes400ResponseError{}
	return &this
}
...
func (o *AccessCodesDeleteAccessCodes400ResponseError) UnmarshalJSON(data []byte) (err error) {
	varAccessCodesDeleteAccessCodes400ResponseError := _AccessCodesDeleteAccessCodes400ResponseError{}

	err = json.Unmarshal(data, &varAccessCodesDeleteAccessCodes400ResponseError)

	if err != nil {
		return err
	}

	*o = AccessCodesDeleteAccessCodes400ResponseError(varAccessCodesDeleteAccessCodes400ResponseError)
...
type NullableAccessCodesDeleteAccessCodes400ResponseError struct {
	value *AccessCodesDeleteAccessCodes400ResponseError
	isSet bool
}
...
func NewNullableAccessCodesDeleteAccessCodes400ResponseError(val *AccessCodesDeleteAccessCodes400ResponseError) *NullableAccessCodesDeleteAccessCodes400ResponseError {
	return &NullableAccessCodesDeleteAccessCodes400ResponseError{value: val, isSet: true}
}
