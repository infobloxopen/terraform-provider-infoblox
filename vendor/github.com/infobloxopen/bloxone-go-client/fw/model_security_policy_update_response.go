...
// checks if the SecurityPolicyUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPolicyUpdateResponse{}
...
func NewSecurityPolicyUpdateResponse() *SecurityPolicyUpdateResponse {
	this := SecurityPolicyUpdateResponse{}
	return &this
}
...
type NullableSecurityPolicyUpdateResponse struct {
	value *SecurityPolicyUpdateResponse
	isSet bool
}
...
func NewNullableSecurityPolicyUpdateResponse(val *SecurityPolicyUpdateResponse) *NullableSecurityPolicyUpdateResponse {
	return &NullableSecurityPolicyUpdateResponse{value: val, isSet: true}
}
