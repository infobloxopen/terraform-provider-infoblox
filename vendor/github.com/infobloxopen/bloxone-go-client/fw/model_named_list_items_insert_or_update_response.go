...
// checks if the NamedListItemsInsertOrUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamedListItemsInsertOrUpdateResponse{}
...
type _NamedListItemsInsertOrUpdateResponse NamedListItemsInsertOrUpdateResponse
...
func NewNamedListItemsInsertOrUpdateResponse() *NamedListItemsInsertOrUpdateResponse {
	this := NamedListItemsInsertOrUpdateResponse{}
	return &this
}
...
func (o *NamedListItemsInsertOrUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	varNamedListItemsInsertOrUpdateResponse := _NamedListItemsInsertOrUpdateResponse{}

	err = json.Unmarshal(data, &varNamedListItemsInsertOrUpdateResponse)

	if err != nil {
		return err
	}

	*o = NamedListItemsInsertOrUpdateResponse(varNamedListItemsInsertOrUpdateResponse)
...
type NullableNamedListItemsInsertOrUpdateResponse struct {
	value *NamedListItemsInsertOrUpdateResponse
	isSet bool
}
...
func NewNullableNamedListItemsInsertOrUpdateResponse(val *NamedListItemsInsertOrUpdateResponse) *NullableNamedListItemsInsertOrUpdateResponse {
	return &NullableNamedListItemsInsertOrUpdateResponse{value: val, isSet: true}
}
