...
// checks if the SecurityPolicyDeleteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPolicyDeleteRequest{}
...
type _SecurityPolicyDeleteRequest SecurityPolicyDeleteRequest
...
func NewSecurityPolicyDeleteRequest() *SecurityPolicyDeleteRequest {
	this := SecurityPolicyDeleteRequest{}
	return &this
}
...
func (o *SecurityPolicyDeleteRequest) UnmarshalJSON(data []byte) (err error) {
	varSecurityPolicyDeleteRequest := _SecurityPolicyDeleteRequest{}

	err = json.Unmarshal(data, &varSecurityPolicyDeleteRequest)

	if err != nil {
		return err
	}

	*o = SecurityPolicyDeleteRequest(varSecurityPolicyDeleteRequest)
...
type NullableSecurityPolicyDeleteRequest struct {
	value *SecurityPolicyDeleteRequest
	isSet bool
}
...
func NewNullableSecurityPolicyDeleteRequest(val *SecurityPolicyDeleteRequest) *NullableSecurityPolicyDeleteRequest {
	return &NullableSecurityPolicyDeleteRequest{value: val, isSet: true}
}
