...
func (v *NetAddrDfpAssignmentScopeType) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := NetAddrDfpAssignmentScopeType(value)
	for _, existing := range AllowedNetAddrDfpAssignmentScopeTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid NetAddrDfpAssignmentScopeType", value)
}

// NewNetAddrDfpAssignmentScopeTypeFromValue returns a pointer to a valid NetAddrDfpAssignmentScopeType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewNetAddrDfpAssignmentScopeTypeFromValue(v string) (*NetAddrDfpAssignmentScopeType, error) {
	ev := NetAddrDfpAssignmentScopeType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for NetAddrDfpAssignmentScopeType: valid values are %v", v, AllowedNetAddrDfpAssignmentScopeTypeEnumValues)
	}
}
...
type NullableNetAddrDfpAssignmentScopeType struct {
	value *NetAddrDfpAssignmentScopeType
	isSet bool
}
...
func NewNullableNetAddrDfpAssignmentScopeType(val *NetAddrDfpAssignmentScopeType) *NullableNetAddrDfpAssignmentScopeType {
	return &NullableNetAddrDfpAssignmentScopeType{value: val, isSet: true}
}
