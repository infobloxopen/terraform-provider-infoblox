...
// checks if the NetworkListReadResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkListReadResponse{}
...
type _NetworkListReadResponse NetworkListReadResponse
...
func (o *NetworkListReadResponse) UnmarshalJSON(data []byte) (err error) {
	varNetworkListReadResponse := _NetworkListReadResponse{}

	err = json.Unmarshal(data, &varNetworkListReadResponse)

	if err != nil {
		return err
	}

	*o = NetworkListReadResponse(varNetworkListReadResponse)
...
func NewNullableNetworkListReadResponse(val *NetworkListReadResponse) *NullableNetworkListReadResponse {
	return &NullableNetworkListReadResponse{value: val, isSet: true}
}
