...
// checks if the AccessCodesCreateAccessCode400ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessCodesCreateAccessCode400ResponseError{}
...
type _AccessCodesCreateAccessCode400ResponseError AccessCodesCreateAccessCode400ResponseError
...
func NewAccessCodesCreateAccessCode400ResponseError() *AccessCodesCreateAccessCode400ResponseError {
	this := AccessCodesCreateAccessCode400ResponseError{}
	return &this
}
...
func (o *AccessCodesCreateAccessCode400ResponseError) UnmarshalJSON(data []byte) (err error) {
	varAccessCodesCreateAccessCode400ResponseError := _AccessCodesCreateAccessCode400ResponseError{}

	err = json.Unmarshal(data, &varAccessCodesCreateAccessCode400ResponseError)

	if err != nil {
		return err
	}

	*o = AccessCodesCreateAccessCode400ResponseError(varAccessCodesCreateAccessCode400ResponseError)
...
type NullableAccessCodesCreateAccessCode400ResponseError struct {
	value *AccessCodesCreateAccessCode400ResponseError
	isSet bool
}
...
func NewNullableAccessCodesCreateAccessCode400ResponseError(val *AccessCodesCreateAccessCode400ResponseError) *NullableAccessCodesCreateAccessCode400ResponseError {
	return &NullableAccessCodesCreateAccessCode400ResponseError{value: val, isSet: true}
}
