...
type _NetworkListsCreateNetworkList409ResponseError NetworkListsCreateNetworkList409ResponseError
...
func (o *NetworkListsCreateNetworkList409ResponseError) UnmarshalJSON(data []byte) (err error) {
	varNetworkListsCreateNetworkList409ResponseError := _NetworkListsCreateNetworkList409ResponseError{}

	err = json.Unmarshal(data, &varNetworkListsCreateNetworkList409ResponseError)

	if err != nil {
		return err
	}

	*o = NetworkListsCreateNetworkList409ResponseError(varNetworkListsCreateNetworkList409ResponseError)
