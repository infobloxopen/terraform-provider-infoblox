...
// checks if the CategoryFilterUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryFilterUpdateResponse{}
...
type _CategoryFilterUpdateResponse CategoryFilterUpdateResponse
...
func NewCategoryFilterUpdateResponse() *CategoryFilterUpdateResponse {
	this := CategoryFilterUpdateResponse{}
	return &this
}
...
func (o *CategoryFilterUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	varCategoryFilterUpdateResponse := _CategoryFilterUpdateResponse{}

	err = json.Unmarshal(data, &varCategoryFilterUpdateResponse)

	if err != nil {
		return err
	}

	*o = CategoryFilterUpdateResponse(varCategoryFilterUpdateResponse)
...
type NullableCategoryFilterUpdateResponse struct {
	value *CategoryFilterUpdateResponse
	isSet bool
}
...
func NewNullableCategoryFilterUpdateResponse(val *CategoryFilterUpdateResponse) *NullableCategoryFilterUpdateResponse {
	return &NullableCategoryFilterUpdateResponse{value: val, isSet: true}
}
