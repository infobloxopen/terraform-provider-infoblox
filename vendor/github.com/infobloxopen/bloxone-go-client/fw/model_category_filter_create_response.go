...
// checks if the CategoryFilterCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryFilterCreateResponse{}
...
type _CategoryFilterCreateResponse CategoryFilterCreateResponse
...
func NewCategoryFilterCreateResponse() *CategoryFilterCreateResponse {
	this := CategoryFilterCreateResponse{}
	return &this
}
...
func (o *CategoryFilterCreateResponse) UnmarshalJSON(data []byte) (err error) {
	varCategoryFilterCreateResponse := _CategoryFilterCreateResponse{}

	err = json.Unmarshal(data, &varCategoryFilterCreateResponse)

	if err != nil {
		return err
	}

	*o = CategoryFilterCreateResponse(varCategoryFilterCreateResponse)
...
type NullableCategoryFilterCreateResponse struct {
	value *CategoryFilterCreateResponse
	isSet bool
}
...
func NewNullableCategoryFilterCreateResponse(val *CategoryFilterCreateResponse) *NullableCategoryFilterCreateResponse {
	return &NullableCategoryFilterCreateResponse{value: val, isSet: true}
}
