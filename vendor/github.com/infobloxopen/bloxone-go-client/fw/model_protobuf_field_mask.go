...
type _ProtobufFieldMask ProtobufFieldMask
...
func (o *ProtobufFieldMask) UnmarshalJSON(data []byte) (err error) {
	varProtobufFieldMask := _ProtobufFieldMask{}

	err = json.Unmarshal(data, &varProtobufFieldMask)

	if err != nil {
		return err
	}

	*o = ProtobufFieldMask(varProtobufFieldMask)
