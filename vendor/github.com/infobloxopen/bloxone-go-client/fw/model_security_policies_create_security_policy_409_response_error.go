...
// checks if the SecurityPoliciesCreateSecurityPolicy409ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPoliciesCreateSecurityPolicy409ResponseError{}
...
type _SecurityPoliciesCreateSecurityPolicy409ResponseError SecurityPoliciesCreateSecurityPolicy409ResponseError

// NewSecurityPoliciesCreateSecurityPolicy409ResponseError instantiates a new SecurityPoliciesCreateSecurityPolicy409ResponseError object
...
func NewSecurityPoliciesCreateSecurityPolicy409ResponseError() *SecurityPoliciesCreateSecurityPolicy409ResponseError {
	this := SecurityPoliciesCreateSecurityPolicy409ResponseError{}
	return &this
}

// NewSecurityPoliciesCreateSecurityPolicy409ResponseErrorWithDefaults instantiates a new SecurityPoliciesCreateSecurityPolicy409ResponseError object
...
func (o *SecurityPoliciesCreateSecurityPolicy409ResponseError) UnmarshalJSON(data []byte) (err error) {
	varSecurityPoliciesCreateSecurityPolicy409ResponseError := _SecurityPoliciesCreateSecurityPolicy409ResponseError{}

	err = json.Unmarshal(data, &varSecurityPoliciesCreateSecurityPolicy409ResponseError)

	if err != nil {
		return err
	}

	*o = SecurityPoliciesCreateSecurityPolicy409ResponseError(varSecurityPoliciesCreateSecurityPolicy409ResponseError)
...
type NullableSecurityPoliciesCreateSecurityPolicy409ResponseError struct {
	value *SecurityPoliciesCreateSecurityPolicy409ResponseError
	isSet bool
}
...
func NewNullableSecurityPoliciesCreateSecurityPolicy409ResponseError(val *SecurityPoliciesCreateSecurityPolicy409ResponseError) *NullableSecurityPoliciesCreateSecurityPolicy409ResponseError {
	return &NullableSecurityPoliciesCreateSecurityPolicy409ResponseError{value: val, isSet: true}
}
