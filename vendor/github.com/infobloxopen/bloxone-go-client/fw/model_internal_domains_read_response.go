...
// checks if the InternalDomainsReadResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalDomainsReadResponse{}
...
func NewInternalDomainsReadResponse() *InternalDomainsReadResponse {
	this := InternalDomainsReadResponse{}
	return &this
}
...
type NullableInternalDomainsReadResponse struct {
	value *InternalDomainsReadResponse
	isSet bool
}
...
func NewNullableInternalDomainsReadResponse(val *InternalDomainsReadResponse) *NullableInternalDomainsReadResponse {
	return &NullableInternalDomainsReadResponse{value: val, isSet: true}
}
