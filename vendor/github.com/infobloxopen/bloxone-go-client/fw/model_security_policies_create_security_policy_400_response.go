...
// checks if the SecurityPoliciesCreateSecurityPolicy400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPoliciesCreateSecurityPolicy400Response{}
...
type _SecurityPoliciesCreateSecurityPolicy400Response SecurityPoliciesCreateSecurityPolicy400Response
...
func NewSecurityPoliciesCreateSecurityPolicy400Response() *SecurityPoliciesCreateSecurityPolicy400Response {
	this := SecurityPoliciesCreateSecurityPolicy400Response{}
	return &this
}
...
func (o *SecurityPoliciesCreateSecurityPolicy400Response) GetError() SecurityPoliciesCreateSecurityPolicy400ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret SecurityPoliciesCreateSecurityPolicy400ResponseError
		return ret
	}
	return *o.Error
}
...
func (o *SecurityPoliciesCreateSecurityPolicy400Response) UnmarshalJSON(data []byte) (err error) {
	varSecurityPoliciesCreateSecurityPolicy400Response := _SecurityPoliciesCreateSecurityPolicy400Response{}

	err = json.Unmarshal(data, &varSecurityPoliciesCreateSecurityPolicy400Response)

	if err != nil {
		return err
	}

	*o = SecurityPoliciesCreateSecurityPolicy400Response(varSecurityPoliciesCreateSecurityPolicy400Response)
...
type NullableSecurityPoliciesCreateSecurityPolicy400Response struct {
	value *SecurityPoliciesCreateSecurityPolicy400Response
	isSet bool
}
...
func NewNullableSecurityPoliciesCreateSecurityPolicy400Response(val *SecurityPoliciesCreateSecurityPolicy400Response) *NullableSecurityPoliciesCreateSecurityPolicy400Response {
	return &NullableSecurityPoliciesCreateSecurityPolicy400Response{value: val, isSet: true}
}
