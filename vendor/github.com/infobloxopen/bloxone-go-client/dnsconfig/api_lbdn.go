...
func (a *LbdnAPIService) CreateExecute(r LbdnAPICreateRequest) (*CreateLBDNResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue *CreateLBDNResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "LbdnAPIService.Create")
	if err != nil {
...
func (a *LbdnAPIService) DeleteExecute(r LbdnAPIDeleteRequest) (*http.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "LbdnAPIService.Delete")
	if err != nil {
...
func (a *LbdnAPIService) ListExecute(r LbdnAPIListRequest) (*ListLBDNResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []internal.FormFile
		localVarReturnValue *ListLBDNResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "LbdnAPIService.List")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
...
func (a *LbdnAPIService) ReadExecute(r LbdnAPIReadRequest) (*ReadLBDNResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []internal.FormFile
		localVarReturnValue *ReadLBDNResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "LbdnAPIService.Read")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
...
func (a *LbdnAPIService) UpdateExecute(r LbdnAPIUpdateRequest) (*UpdateLBDNResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []internal.FormFile
		localVarReturnValue *UpdateLBDNResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "LbdnAPIService.Update")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
