...
// checks if the ConvertDomainNameResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertDomainNameResponse{}
...
func NewConvertDomainNameResponse() *ConvertDomainNameResponse {
	this := ConvertDomainNameResponse{}
	return &this
}
...
type NullableConvertDomainNameResponse struct {
	value *ConvertDomainNameResponse
	isSet bool
}
...
func NewNullableConvertDomainNameResponse(val *ConvertDomainNameResponse) *NullableConvertDomainNameResponse {
	return &NullableConvertDomainNameResponse{value: val, isSet: true}
}
