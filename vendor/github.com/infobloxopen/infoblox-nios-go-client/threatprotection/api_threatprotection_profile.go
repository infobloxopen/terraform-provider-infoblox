...
func (r ThreatprotectionProfileAPIListRequest) ProxySearch(proxySearch string) ThreatprotectionProfileAPIListRequest {
...
// Search Grid members for data
func (r ThreatprotectionProfileAPIReadRequest) ProxySearch(proxySearch string) ThreatprotectionProfileAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
