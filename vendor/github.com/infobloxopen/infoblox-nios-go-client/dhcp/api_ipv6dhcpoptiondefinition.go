...
func (r Ipv6dhcpoptiondefinitionAPIListRequest) ProxySearch(proxySearch string) Ipv6dhcpoptiondefinitionAPIListRequest {
...
// Search Grid members for data
func (r Ipv6dhcpoptiondefinitionAPIReadRequest) ProxySearch(proxySearch string) Ipv6dhcpoptiondefinitionAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
