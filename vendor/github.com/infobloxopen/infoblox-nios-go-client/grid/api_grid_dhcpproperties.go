...
func (r GridDhcppropertiesAPIListRequest) ProxySearch(proxySearch string) GridDhcppropertiesAPIListRequest {
...
// Search Grid members for data
func (r GridDhcppropertiesAPIReadRequest) ProxySearch(proxySearch string) GridDhcppropertiesAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
