...
// checks if the GridTrafficCaptureQpsSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridTrafficCaptureQpsSetting{}

// GridTrafficCaptureQpsSetting struct for GridTrafficCaptureQpsSetting
type GridTrafficCaptureQpsSetting struct {
...
type _GridTrafficCaptureQpsSetting GridTrafficCaptureQpsSetting
...
func NewGridTrafficCaptureQpsSetting() *GridTrafficCaptureQpsSetting {
	this := GridTrafficCaptureQpsSetting{}
	return &this
}
...
func (o GridTrafficCaptureQpsSetting) MarshalJSON() ([]byte, error) {
...
func (o GridTrafficCaptureQpsSetting) ToMap() (map[string]interface{}, error) {
...
func (o *GridTrafficCaptureQpsSetting) UnmarshalJSON(data []byte) (err error) {
	varGridTrafficCaptureQpsSetting := _GridTrafficCaptureQpsSetting{}

	err = json.Unmarshal(data, &varGridTrafficCaptureQpsSetting)

	if err != nil {
		return err
	}

	*o = GridTrafficCaptureQpsSetting(varGridTrafficCaptureQpsSetting)
...
type NullableGridTrafficCaptureQpsSetting struct {
	value *GridTrafficCaptureQpsSetting
	isSet bool
}

func (v NullableGridTrafficCaptureQpsSetting) Get() *GridTrafficCaptureQpsSetting {
	return v.value
}

func (v *NullableGridTrafficCaptureQpsSetting) Set(val *GridTrafficCaptureQpsSetting) {
	v.value = val
	v.isSet = true
}

func (v NullableGridTrafficCaptureQpsSetting) IsSet() bool {
	return v.isSet
}

func (v *NullableGridTrafficCaptureQpsSetting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridTrafficCaptureQpsSetting(val *GridTrafficCaptureQpsSetting) *NullableGridTrafficCaptureQpsSetting {
	return &NullableGridTrafficCaptureQpsSetting{value: val, isSet: true}
}

func (v NullableGridTrafficCaptureQpsSetting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridTrafficCaptureQpsSetting) UnmarshalJSON(src []byte) error {
	v.isSet = true
