...
// checks if the MemberdnsattackmitigationDetectChr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberdnsattackmitigationDetectChr{}

// MemberdnsattackmitigationDetectChr struct for MemberdnsattackmitigationDetectChr
type MemberdnsattackmitigationDetectChr struct {
...
type _MemberdnsattackmitigationDetectChr MemberdnsattackmitigationDetectChr
...
func NewMemberdnsattackmitigationDetectChr() *MemberdnsattackmitigationDetectChr {
	this := MemberdnsattackmitigationDetectChr{}
	return &this
}
...
func (o MemberdnsattackmitigationDetectChr) MarshalJSON() ([]byte, error) {
...
func (o MemberdnsattackmitigationDetectChr) ToMap() (map[string]interface{}, error) {
...
func (o *MemberdnsattackmitigationDetectChr) UnmarshalJSON(data []byte) (err error) {
	varMemberdnsattackmitigationDetectChr := _MemberdnsattackmitigationDetectChr{}

	err = json.Unmarshal(data, &varMemberdnsattackmitigationDetectChr)

	if err != nil {
		return err
	}

	*o = MemberdnsattackmitigationDetectChr(varMemberdnsattackmitigationDetectChr)
...
type NullableMemberdnsattackmitigationDetectChr struct {
	value *MemberdnsattackmitigationDetectChr
	isSet bool
}

func (v NullableMemberdnsattackmitigationDetectChr) Get() *MemberdnsattackmitigationDetectChr {
	return v.value
}

func (v *NullableMemberdnsattackmitigationDetectChr) Set(val *MemberdnsattackmitigationDetectChr) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberdnsattackmitigationDetectChr) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberdnsattackmitigationDetectChr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberdnsattackmitigationDetectChr(val *MemberdnsattackmitigationDetectChr) *NullableMemberdnsattackmitigationDetectChr {
	return &NullableMemberdnsattackmitigationDetectChr{value: val, isSet: true}
}

func (v NullableMemberdnsattackmitigationDetectChr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberdnsattackmitigationDetectChr) UnmarshalJSON(src []byte) error {
	v.isSet = true
