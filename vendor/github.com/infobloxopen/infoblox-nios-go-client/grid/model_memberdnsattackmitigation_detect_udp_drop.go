...
// checks if the MemberdnsattackmitigationDetectUdpDrop type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberdnsattackmitigationDetectUdpDrop{}

// MemberdnsattackmitigationDetectUdpDrop struct for MemberdnsattackmitigationDetectUdpDrop
type MemberdnsattackmitigationDetectUdpDrop struct {
...
type _MemberdnsattackmitigationDetectUdpDrop MemberdnsattackmitigationDetectUdpDrop
...
func NewMemberdnsattackmitigationDetectUdpDrop() *MemberdnsattackmitigationDetectUdpDrop {
	this := MemberdnsattackmitigationDetectUdpDrop{}
	return &this
}
...
func (o MemberdnsattackmitigationDetectUdpDrop) MarshalJSON() ([]byte, error) {
...
func (o MemberdnsattackmitigationDetectUdpDrop) ToMap() (map[string]interface{}, error) {
...
func (o *MemberdnsattackmitigationDetectUdpDrop) UnmarshalJSON(data []byte) (err error) {
	varMemberdnsattackmitigationDetectUdpDrop := _MemberdnsattackmitigationDetectUdpDrop{}

	err = json.Unmarshal(data, &varMemberdnsattackmitigationDetectUdpDrop)

	if err != nil {
		return err
	}

	*o = MemberdnsattackmitigationDetectUdpDrop(varMemberdnsattackmitigationDetectUdpDrop)
...
type NullableMemberdnsattackmitigationDetectUdpDrop struct {
	value *MemberdnsattackmitigationDetectUdpDrop
	isSet bool
}

func (v NullableMemberdnsattackmitigationDetectUdpDrop) Get() *MemberdnsattackmitigationDetectUdpDrop {
	return v.value
}

func (v *NullableMemberdnsattackmitigationDetectUdpDrop) Set(val *MemberdnsattackmitigationDetectUdpDrop) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberdnsattackmitigationDetectUdpDrop) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberdnsattackmitigationDetectUdpDrop) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberdnsattackmitigationDetectUdpDrop(val *MemberdnsattackmitigationDetectUdpDrop) *NullableMemberdnsattackmitigationDetectUdpDrop {
	return &NullableMemberdnsattackmitigationDetectUdpDrop{value: val, isSet: true}
}

func (v NullableMemberdnsattackmitigationDetectUdpDrop) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberdnsattackmitigationDetectUdpDrop) UnmarshalJSON(src []byte) error {
	v.isSet = true
