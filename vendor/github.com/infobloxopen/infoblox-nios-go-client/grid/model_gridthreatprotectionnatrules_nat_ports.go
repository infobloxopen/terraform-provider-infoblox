...
// checks if the GridthreatprotectionnatrulesNatPorts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridthreatprotectionnatrulesNatPorts{}

// GridthreatprotectionnatrulesNatPorts struct for GridthreatprotectionnatrulesNatPorts
type GridthreatprotectionnatrulesNatPorts struct {
...
type _GridthreatprotectionnatrulesNatPorts GridthreatprotectionnatrulesNatPorts
...
func NewGridthreatprotectionnatrulesNatPorts() *GridthreatprotectionnatrulesNatPorts {
	this := GridthreatprotectionnatrulesNatPorts{}
	return &this
}
...
func (o GridthreatprotectionnatrulesNatPorts) MarshalJSON() ([]byte, error) {
...
func (o GridthreatprotectionnatrulesNatPorts) ToMap() (map[string]interface{}, error) {
...
func (o *GridthreatprotectionnatrulesNatPorts) UnmarshalJSON(data []byte) (err error) {
	varGridthreatprotectionnatrulesNatPorts := _GridthreatprotectionnatrulesNatPorts{}

	err = json.Unmarshal(data, &varGridthreatprotectionnatrulesNatPorts)

	if err != nil {
		return err
	}

	*o = GridthreatprotectionnatrulesNatPorts(varGridthreatprotectionnatrulesNatPorts)
...
type NullableGridthreatprotectionnatrulesNatPorts struct {
	value *GridthreatprotectionnatrulesNatPorts
	isSet bool
}

func (v NullableGridthreatprotectionnatrulesNatPorts) Get() *GridthreatprotectionnatrulesNatPorts {
	return v.value
}

func (v *NullableGridthreatprotectionnatrulesNatPorts) Set(val *GridthreatprotectionnatrulesNatPorts) {
	v.value = val
	v.isSet = true
}

func (v NullableGridthreatprotectionnatrulesNatPorts) IsSet() bool {
	return v.isSet
}

func (v *NullableGridthreatprotectionnatrulesNatPorts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridthreatprotectionnatrulesNatPorts(val *GridthreatprotectionnatrulesNatPorts) *NullableGridthreatprotectionnatrulesNatPorts {
	return &NullableGridthreatprotectionnatrulesNatPorts{value: val, isSet: true}
}

func (v NullableGridthreatprotectionnatrulesNatPorts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridthreatprotectionnatrulesNatPorts) UnmarshalJSON(src []byte) error {
	v.isSet = true
