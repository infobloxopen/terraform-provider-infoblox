...
func (r GmcgroupAPIListRequest) ProxySearch(proxySearch string) GmcgroupAPIListRequest {
...
// Search Grid members for data
func (r GmcgroupAPIReadRequest) ProxySearch(proxySearch string) GmcgroupAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
