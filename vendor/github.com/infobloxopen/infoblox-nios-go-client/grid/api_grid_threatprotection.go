...
func (r GridThreatprotectionAPIListRequest) ProxySearch(proxySearch string) GridThreatprotectionAPIListRequest {
...
// Search Grid members for data
func (r GridThreatprotectionAPIReadRequest) ProxySearch(proxySearch string) GridThreatprotectionAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
