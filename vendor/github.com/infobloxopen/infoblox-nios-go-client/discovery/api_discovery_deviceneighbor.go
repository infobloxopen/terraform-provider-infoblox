...
func (r DiscoveryDeviceneighborAPIListRequest) ProxySearch(proxySearch string) DiscoveryDeviceneighborAPIListRequest {
...
// Search Grid members for data
func (r DiscoveryDeviceneighborAPIReadRequest) ProxySearch(proxySearch string) DiscoveryDeviceneighborAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
