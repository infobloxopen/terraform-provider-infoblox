...
func (r DtcRecordCnameAPIListRequest) ProxySearch(proxySearch string) DtcRecordCnameAPIListRequest {
...
// Search Grid members for data
func (r DtcRecordCnameAPIReadRequest) ProxySearch(proxySearch string) DtcRecordCnameAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
