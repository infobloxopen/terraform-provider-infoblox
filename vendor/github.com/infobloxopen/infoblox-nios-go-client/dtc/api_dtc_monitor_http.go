...
func (r DtcMonitorHttpAPIListRequest) ProxySearch(proxySearch string) DtcMonitorHttpAPIListRequest {
...
// Search Grid members for data
func (r DtcMonitorHttpAPIReadRequest) ProxySearch(proxySearch string) DtcMonitorHttpAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
