...
func (r DtcTopologyLabelAPIListRequest) ProxySearch(proxySearch string) DtcTopologyLabelAPIListRequest {
...
// Search Grid members for data
func (r DtcTopologyLabelAPIReadRequest) ProxySearch(proxySearch string) DtcTopologyLabelAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
