...
func (r VlanrangeAPIListRequest) ProxySearch(proxySearch string) VlanrangeAPIListRequest {
...
// Search Grid members for data
func (r VlanrangeAPIReadRequest) ProxySearch(proxySearch string) VlanrangeAPIReadRequest {
	r.proxySearch = &proxySearch
	return r
}
