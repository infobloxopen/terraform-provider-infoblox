...
The Discovery configuration service is a Universal DDI Service that provides configuration for accessing and syncing the Cloud assets 
...
```bash
go get github.com/infobloxopen/universal-ddi-go-client/clouddiscovery
```

Import the package into your code:
```go
import "github.com/infobloxopen/universal-ddi-go-client/clouddiscovery"
```
