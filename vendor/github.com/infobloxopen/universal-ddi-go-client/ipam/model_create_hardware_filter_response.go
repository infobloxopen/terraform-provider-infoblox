...
// checks if the CreateHardwareFilterResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateHardwareFilterResponse{}
...
func NewCreateHardwareFilterResponse() *CreateHardwareFilterResponse {
	this := CreateHardwareFilterResponse{}
	return &this
}
...
func (o CreateHardwareFilterResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateHardwareFilterResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateHardwareFilterResponse struct {
	value *CreateHardwareFilterResponse
	isSet bool
}

func (v NullableCreateHardwareFilterResponse) Get() *CreateHardwareFilterResponse {
	return v.value
}

func (v *NullableCreateHardwareFilterResponse) Set(val *CreateHardwareFilterResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateHardwareFilterResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateHardwareFilterResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateHardwareFilterResponse(val *CreateHardwareFilterResponse) *NullableCreateHardwareFilterResponse {
	return &NullableCreateHardwareFilterResponse{value: val, isSet: true}
}

func (v NullableCreateHardwareFilterResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateHardwareFilterResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
