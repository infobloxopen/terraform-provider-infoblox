...
// checks if the ReadOptionGroupResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReadOptionGroupResponse{}
...
func (o ReadOptionGroupResponse) MarshalJSON() ([]byte, error) {
...
func (o ReadOptionGroupResponse) ToMap() (map[string]interface{}, error) {
...
type NullableReadOptionGroupResponse struct {
	value *ReadOptionGroupResponse
	isSet bool
}

func (v NullableReadOptionGroupResponse) Get() *ReadOptionGroupResponse {
	return v.value
}

func (v *NullableReadOptionGroupResponse) Set(val *ReadOptionGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadOptionGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadOptionGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadOptionGroupResponse(val *ReadOptionGroupResponse) *NullableReadOptionGroupResponse {
	return &NullableReadOptionGroupResponse{value: val, isSet: true}
}

func (v NullableReadOptionGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadOptionGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
