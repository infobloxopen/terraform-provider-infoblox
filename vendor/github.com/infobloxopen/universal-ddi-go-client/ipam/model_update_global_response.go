...
// checks if the UpdateGlobalResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGlobalResponse{}

// UpdateGlobalResponse The response format to update the __Global__ object.
...
func NewNullableUpdateGlobalResponse(val *UpdateGlobalResponse) *NullableUpdateGlobalResponse {
	return &NullableUpdateGlobalResponse{value: val, isSet: true}
}
