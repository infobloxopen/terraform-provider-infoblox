...
// checks if the InheritedDHCPConfigFilterList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InheritedDHCPConfigFilterList{}

// InheritedDHCPConfigFilterList The inheritance configuration for a field of type list of identifier that represent list of filter attached to _DHCPConfig_.
...
func NewInheritedDHCPConfigFilterList() *InheritedDHCPConfigFilterList {
	this := InheritedDHCPConfigFilterList{}
	return &this
}
...
func (o InheritedDHCPConfigFilterList) MarshalJSON() ([]byte, error) {
...
func (o InheritedDHCPConfigFilterList) ToMap() (map[string]interface{}, error) {
...
type NullableInheritedDHCPConfigFilterList struct {
	value *InheritedDHCPConfigFilterList
	isSet bool
}

func (v NullableInheritedDHCPConfigFilterList) Get() *InheritedDHCPConfigFilterList {
	return v.value
}

func (v *NullableInheritedDHCPConfigFilterList) Set(val *InheritedDHCPConfigFilterList) {
	v.value = val
	v.isSet = true
}

func (v NullableInheritedDHCPConfigFilterList) IsSet() bool {
	return v.isSet
}

func (v *NullableInheritedDHCPConfigFilterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInheritedDHCPConfigFilterList(val *InheritedDHCPConfigFilterList) *NullableInheritedDHCPConfigFilterList {
	return &NullableInheritedDHCPConfigFilterList{value: val, isSet: true}
}

func (v NullableInheritedDHCPConfigFilterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInheritedDHCPConfigFilterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
