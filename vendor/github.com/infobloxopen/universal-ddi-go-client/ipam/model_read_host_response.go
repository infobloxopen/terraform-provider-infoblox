...
// checks if the ReadHostResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReadHostResponse{}

// ReadHostResponse The response format to retrieve the DHCP __Host__ object.
...
func NewNullableReadHostResponse(val *ReadHostResponse) *NullableReadHostResponse {
	return &NullableReadHostResponse{value: val, isSet: true}
}
