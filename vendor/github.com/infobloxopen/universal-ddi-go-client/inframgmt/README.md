...
The Services API is used to manage the Infrastructure Service resources (a.k.a. NIOS-X applications).
...
```bash
go get github.com/infobloxopen/universal-ddi-go-client/inframgmt
```

Import the package into your code:
```go
import "github.com/infobloxopen/universal-ddi-go-client/inframgmt"
```
