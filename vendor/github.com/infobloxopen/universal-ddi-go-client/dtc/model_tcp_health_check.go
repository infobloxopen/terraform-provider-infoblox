...
// TCPHealthCheck A __TCPHealthCheck__ (_dtc/health_check_tcp_) represents a DTC __Server__ health check based on the Transmission Control Protocol (TCP).
...
type _TCPHealthCheck TCPHealthCheck
...
func (o *TCPHealthCheck) UnmarshalJSON(data []byte) (err error) {
	...
	varTCPHealthCheck := _TCPHealthCheck{}

	err = json.Unmarshal(data, &varTCPHealthCheck)

	if err != nil {
		return err
	}

	*o = TCPHealthCheck(varTCPHealthCheck)
