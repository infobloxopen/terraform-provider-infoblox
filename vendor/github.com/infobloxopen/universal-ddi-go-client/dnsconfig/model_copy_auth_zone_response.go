...
// checks if the CopyAuthZoneResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyAuthZoneResponse{}
...
func NewNullableCopyAuthZoneResponse(val *CopyAuthZoneResponse) *NullableCopyAuthZoneResponse {
	return &NullableCopyAuthZoneResponse{value: val, isSet: true}
}
