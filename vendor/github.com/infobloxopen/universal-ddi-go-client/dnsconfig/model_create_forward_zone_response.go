...
// checks if the CreateForwardZoneResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateForwardZoneResponse{}
...
func NewCreateForwardZoneResponse() *CreateForwardZoneResponse {
	this := CreateForwardZoneResponse{}
	return &this
}
...
type NullableCreateForwardZoneResponse struct {
	value *CreateForwardZoneResponse
	isSet bool
}
...
func NewNullableCreateForwardZoneResponse(val *CreateForwardZoneResponse) *NullableCreateForwardZoneResponse {
	return &NullableCreateForwardZoneResponse{value: val, isSet: true}
}
