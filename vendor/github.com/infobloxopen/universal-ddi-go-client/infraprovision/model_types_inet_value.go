...
// checks if the TypesInetValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TypesInetValue{}
...
type _TypesInetValue TypesInetValue
...
func (o *TypesInetValue) UnmarshalJSON(data []byte) (err error) {
	varTypesInetValue := _TypesInetValue{}

	err = json.Unmarshal(data, &varTypesInetValue)

	if err != nil {
		return err
	}

	*o = TypesInetValue(varTypesInetValue)
...
func NewNullableTypesInetValue(val *TypesInetValue) *NullableTypesInetValue {
	return &NullableTypesInetValue{value: val, isSet: true}
}
